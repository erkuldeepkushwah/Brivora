  ...
  return (
    <>
      ...
      <div className={"wp-site-blocks"} >
        ...
        <h1 className={"has-text-align-left has-link-color alignwide wp-elements-3 wp-block-post-title has-text-color has-bbe-neutral-000-color has-bbe-display-3-font-size wpbbe-55664e1e"} >Logos</h1>
        </div>
        {" "}
        ...
        {" "}
        <div className={"wp-block-group alignfull has-global-padding is-layout-constrained wp-container-core-group-is-layout-c1dc18d0 wp-block-group-is-layout-constrained has-background"} style={{ borderRadius: "0px", paddingTop: "var(--wp--preset--spacing--bbe-140)", paddingBottom: "var(--wp--preset--spacing--bbe-160)", backgroundSize: "cover" } as CSSProperties} >
        ...
        {" "}
        <figure className={"wp-block-image aligncenter size-large has-custom-border is-style-default wp-duotone-1d273a-f1f5f9-5"} style={{ marginTop: "0", marginRight: "0", marginBottom: "0", marginLeft: "0" } as CSSProperties} >
        <img fetchPriority={"high"} decoding={"async"} width={"800"} height={"400"} src={"https://the7.io/fse-business/wp-content/uploads/sites/133/2026/05/logo-color-03.svg"} alt={""} className={"wp-image-23694"} style={{ borderTopLeftRadius: "0px", borderTopRightRadius: "0px", borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px", objectFit: "contain" } as CSSProperties} />
        </figure>
        {" "}
        <figure className={"wp-block-image aligncenter size-large has-custom-border is-style-default wp-duotone-1d273a-f1f5f9-6"} style={{ marginTop: "0", marginRight: "0", marginBottom: "0", marginLeft: "0" } as CSSProperties} >
        <img decoding={"async"} width={"800"} height={"400"} src={"https://the7.io/fse-business/wp-content/uploads/sites/133/2026/05/logo-color-04.svg"} alt={""} className={"wp-image-23696"} style={{ borderTopLeftRadius: "0px", borderTopRightRadius: "0px", borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px" } as CSSProperties} />
        </figure>
        {" "}
        <figure className={"wp-block-image aligncenter size-large has-custom-border is-style-default wp-duotone-1d273a-f1f5f9-7"} style={{ marginTop: "0", marginRight: "0", marginBottom: "0", marginLeft: "0" } as CSSProperties} >
        <img decoding={"async"} width={"800"} height={"400"} src={"https://the7.io/fse-business/wp-content/uploads/sites/133/2026/05/logo-color-08.svg"} alt={""} className={"wp-image-23695"} style={{ borderTopLeftRadius: "0px", borderTopRightRadius: "0px", borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px" } as CSSProperties} />
        </figure>
        {" "}
        <figure className={"wp-block-image aligncenter size-large has-custom-border is-style-default wp-duotone-1d273a-f1f5f9-8"} style={{ marginTop: "0", marginRight: "0", marginBottom: "0", marginLeft: "0" } as CSSProperties} >
        ...
        {" "}
        <figure className={"wp-block-image aligncenter size-large has-custom-border is-style-default wp-duotone-1d273a-f1f5f9-9"} style={{ marginTop: "0", marginRight: "0", marginBottom: "0", marginLeft: "0" } as CSSProperties} >
        ...
        {" "}
        <figure className={"wp-block-image aligncenter size-large has-custom-border is-style-default wp-duotone-1d273a-f1f5f9-10"} style={{ marginTop: "0", marginRight: "0", marginBottom: "0", marginLeft: "0" } as CSSProperties} >
        ...
        {" "}
        <figure className={"wp-block-image aligncenter size-large has-custom-border is-style-default wp-duotone-1d273a-f1f5f9-11"} style={{ marginTop: "0", marginRight: "0", marginBottom: "0", marginLeft: "0" } as CSSProperties} >
        ...
        {" "}
        <figure className={"wp-block-image aligncenter size-large has-custom-border is-style-default wp-duotone-1d273a-f1f5f9-12"} style={{ marginTop: "0", marginRight: "0", marginBottom: "0", marginLeft: "0" } as CSSProperties} >
        ...
        {" "}
        <div className={"wp-block-group alignwide is-nowrap is-layout-flex wp-container-core-group-is-layout-e16d60d7 wp-block-group-is-layout-flex wpbbe-d67b654f aos-root"} >
        {" "}
        <div className={"wp-block-group alignwide wp-container-content-dc435e0d is-layout-grid wp-container-core-group-is-layout-d0e0f14d wp-block-group-is-layout-grid wpbbe-266141cd"} >
        {" "}
        <div className={"wp-block-group has-global-padding is-layout-constrained wp-container-core-group-is-layout-ccae136f wp-block-group-is-layout-constrained"} style={{ paddingTop: "0", paddingRight: "0", paddingBottom: "0", paddingLeft: "0" } as CSSProperties} >
        {" "}
        <figure data-aos-easing={"ease-out"} data-aos={"slide-up"} className={"wp-block-image aligncenter size-large has-custom-border is-style-default wp-duotone-1d273a-f1f5f9-13 wpbbe-c0bcedef"} style={{ marginTop: "0", marginRight: "0", marginBottom: "0", marginLeft: "0" } as CSSProperties} >
        <img fetchPriority={"high"} decoding={"async"} width={"800"} height={"400"} src={"https://the7.io/fse-business/wp-content/uploads/sites/133/2026/05/logo-color-03.svg"} alt={""} className={"wp-image-23694"} style={{ borderTopLeftRadius: "0px", borderTopRightRadius: "0px", borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px", objectFit: "contain" } as CSSProperties} />
        </figure>
        {" "}
        </div>
        ...
        <div className={"wp-block-group has-global-padding is-layout-constrained wp-container-core-group-is-layout-ccae136f wp-block-group-is-layout-constrained"} style={{ paddingTop: "0", paddingRight: "0", paddingBottom: "0", paddingLeft: "0" } as CSSProperties} >
        {" "}
        <figure data-aos-easing={"ease-out"} data-aos={"slide-up"} className={"wp-block-image aligncenter size-large has-custom-border is-style-default wp-duotone-1d273a-f1f5f9-14 wpbbe-1c862e24"} style={{ marginTop: "0", marginRight: "0", marginBottom: "0", marginLeft: "0" } as CSSProperties} >
        <img loading={"lazy"} decoding={"async"} width={"800"} height={"400"} src={"https://the7.io/fse-business/wp-content/uploads/sites/133/2026/05/logo-color-11.svg"} alt={""} className={"wp-image-23692"} style={{ borderTopLeftRadius: "0px", borderTopRightRadius: "0px", borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px", objectFit: "contain" } as CSSProperties} />
        </figure>
        {" "}
        </div>
        {" "}
        ...
        {" "}
        <div className={"wp-block-group alignwide wp-container-content-9e2f13cb is-layout-grid wp-container-core-group-is-layout-e1d42ed7 wp-block-group-is-layout-grid wpbbe-1307e0fc"} >
        {" "}
        <div className={"wp-block-group has-global-padding is-layout-constrained wp-container-core-group-is-layout-ccae136f wp-block-group-is-layout-constrained"} style={{ paddingTop: "0", paddingRight: "0", paddingBottom: "0", paddingLeft: "0" } as CSSProperties} >
        {" "}
        <figure data-aos-easing={"ease-out"} data-aos={"slide-up"} className={"wp-block-image aligncenter size-large has-custom-border is-style-default wp-duotone-1d273a-f1f5f9-15 wpbbe-3d75a473"} style={{ marginTop: "0", marginRight: "0", marginBottom: "0", marginLeft: "0" } as CSSProperties} >
        ...
        <div className={"wp-block-group has-global-padding is-layout-constrained wp-container-core-group-is-layout-ccae136f wp-block-group-is-layout-constrained"} style={{ paddingTop: "0", paddingRight: "0", paddingBottom: "0", paddingLeft: "0" } as CSSProperties} >
        {" "}
        <figure data-aos-easing={"ease-out"} data-aos={"slide-up"} className={"wp-block-image aligncenter size-large has-custom-border is-style-default wp-duotone-1d273a-f1f5f9-16 wpbbe-c1c4ae46"} style={{ marginTop: "0", marginRight: "0", marginBottom: "0", marginLeft: "0" } as CSSProperties} >
        ...
        <div className={"wp-block-group has-global-padding is-layout-constrained wp-container-core-group-is-layout-ccae136f wp-block-group-is-layout-constrained"} style={{ paddingTop: "0", paddingRight: "0", paddingBottom: "0", paddingLeft: "0" } as CSSProperties} >
        {" "}
        <figure data-aos-easing={"ease-out"} data-aos={"slide-up"} className={"wp-block-image aligncenter size-large has-custom-border is-style-default wp-duotone-1d273a-f1f5f9-17 wpbbe-514ef2e0"} style={{ marginTop: "0", marginRight: "0", marginBottom: "0", marginLeft: "0" } as CSSProperties} >
        ...
        {" "}
        <div className={"wp-block-group alignwide has-bbe-neutral-100-background-color has-background is-layout-flow wp-container-core-group-is-layout-232106bc wp-block-group-is-layout-flow"} style={{ paddingTop: "var(--wp--preset--spacing--bbe-90)", paddingRight: "var(--wp--preset--spacing--bbe-90)", paddingBottom: "var(--wp--preset--spacing--bbe-90)", paddingLeft: "var(--wp--preset--spacing--bbe-90)" } as CSSProperties} >
        {" "}
        <h3 className={"wp-block-heading alignwide"} >Pre-made layouts</h3>
        {" "}
        <nav style={{ fontStyle: "normal", fontWeight: "600", lineHeight: "1.3", "--wp-navigation-hover": "var(--wp--preset--color--bbe-primary-600)" } as CSSProperties} className={"has-text-color has-bbe-neutral-900-color has-bbe-large-font-size items-justified-left wp-block-navigation is-horizontal is-content-justification-left is-layout-flex wp-container-core-navigation-is-layout-d249ab57 wp-block-navigation-is-layout-flex has-hover"} aria-label={"Layouts Nav"} >
        <ul style={{ fontStyle: "normal", fontWeight: "600", lineHeight: "1.3" } as CSSProperties} className={"wp-block-navigation__container has-text-color has-bbe-neutral-900-color has-bbe-large-font-size items-justified-left wp-block-navigation"} >
        <li style={{ letterSpacing: "0em" } as CSSProperties} className={"wp-block-navigation-item wp-block-navigation-link"} >
        <a className={"wp-block-navigation-item__content"} href={"https://the7.io/fse-business/more/accordion/"} >
        <span className={"wp-block-navigation-item__label"} >Accordion</span>
        </a>
        </li>
        <li className={"wp-block-navigation-item wp-block-navigation-link"} >
        <a className={"wp-block-navigation-item__content"} href={"https://the7.io/fse-business/more/blog-cards/"} >
        <span className={"wp-block-navigation-item__label"} >Blog cards</span>
        </a>
        </li>
        <li style={{ letterSpacing: "0em" } as CSSProperties} className={"wp-block-navigation-item wp-block-navigation-link"} >
        <a className={"wp-block-navigation-item__content"} href={"https://the7.io/fse-business/more/case-cards/"} >
        <span className={"wp-block-navigation-item__label"} >Case cards</span>
        </a>
        </li>
        <li style={{ letterSpacing: "0em" } as CSSProperties} className={"wp-block-navigation-item wp-block-navigation-link"} >
        <a className={"wp-block-navigation-item__content"} href={"https://the7.io/fse-business/more/cta/"} >
        <span className={"wp-block-navigation-item__label"} >CTA</span>
        </a>
        </li>
        <li style={{ letterSpacing: "0em" } as CSSProperties} className={"wp-block-navigation-item wp-block-navigation-link"} >
        <a className={"wp-block-navigation-item__content"} href={"https://the7.io/fse-business/blocks/icon-cards/"} >
        <span className={"wp-block-navigation-item__label"} >Icon cards</span>
        </a>
        </li>
        <li style={{ letterSpacing: "0em" } as CSSProperties} className={"wp-block-navigation-item wp-block-navigation-link"} >
        <a className={"wp-block-navigation-item__content"} href={"https://the7.io/fse-business/blocks/image-cards/"} >
        <span className={"wp-block-navigation-item__label"} >Image cards</span>
        </a>
        </li>
        <li style={{ letterSpacing: "0em" } as CSSProperties} className={"wp-block-navigation-item wp-block-navigation-link"} >
        <a className={"wp-block-navigation-item__content"} href={"https://the7.io/fse-business/blocks/lists/"} >
        <span className={"wp-block-navigation-item__label"} >Lists</span>
        </a>
        </li>
        <li style={{ letterSpacing: "0em" } as CSSProperties} className={"wp-block-navigation-item current-menu-item wp-block-navigation-link"} >
        <a className={"wp-block-navigation-item__content"} href={"https://the7.io/fse-business/more/logos/"} aria-current={"page"} >
        <span className={"wp-block-navigation-item__label"} >Logos</span>
        </a>
        </li>
        <li style={{ letterSpacing: "0em" } as CSSProperties} className={"wp-block-navigation-item wp-block-navigation-link"} >
        <a className={"wp-block-navigation-item__content"} href={"https://the7.io/fse-business/blocks/numbers/"} >
        <span className={"wp-block-navigation-item__label"} >Numbers</span>
        </a>
        </li>
        <li className={"wp-block-navigation-item wp-block-navigation-link"} >
        <a className={"wp-block-navigation-item__content"} href={"https://the7.io/fse-business/more/section-with-content/"} >
        <span className={"wp-block-navigation-item__label"} >Section with content</span>
        </a>
        </li>
        <li className={"wp-block-navigation-item wp-block-navigation-link"} >
        <a className={"wp-block-navigation-item__content"} href={"https://the7.io/fse-business/more/section-with-images/"} >
        <span className={"wp-block-navigation-item__label"} >Section with images</span>
        </a>
        </li>
        <li style={{ letterSpacing: "0em" } as CSSProperties} className={"wp-block-navigation-item wp-block-navigation-link"} >
        <a className={"wp-block-navigation-item__content"} href={"https://the7.io/fse-business/blocks/team/"} >
        <span className={"wp-block-navigation-item__label"} >Team</span>
        </a>
        </li>
        <li style={{ letterSpacing: "0em" } as CSSProperties} className={"wp-block-navigation-item wp-block-navigation-link"} >
        <a className={"wp-block-navigation-item__content"} href={"https://the7.io/fse-business/blocks/testimonials/"} >
        <span className={"wp-block-navigation-item__label"} >Testimonials</span>
        </a>
        </li>
        <li className={"wp-block-navigation-item wp-block-navigation-link"} >
        <a className={"wp-block-navigation-item__content"} href={"https://the7.io/fse-business/more/steps/"} >
        <span className={"wp-block-navigation-item__label"} >Steps & timeline</span>
        </a>
        </li>
        </ul>
        </nav>
        ...
        {" "}
        <p className={"has-bbe-neutral-900-color has-text-color has-link-color wp-elements-4 wpbbe-text-style-from-element-h5 wp-block-heading wp-block-paragraph"} >
        <mark style={{ backgroundColor: "rgba(0, 0, 0, 0)" } as CSSProperties} className={"has-inline-color has-bbe-primary-600-color"} >Call:</mark>
        {" +1-001-234-5678"}
        </p>
        {" "}
        ...
        {" "}
        <p className={"has-bbe-neutral-900-color has-text-color has-link-color wp-elements-5 wpbbe-text-style-from-element-h6 wp-block-heading wp-block-paragraph"} >Info</p>
        {" "}
        ...
        <div className={"wp-block-group is-layout-flow wp-container-core-group-is-layout-2d0a040d wp-block-group-is-layout-flow"} >
        {" "}
        <p className={"has-bbe-neutral-900-color has-text-color has-link-color wp-elements-6 wpbbe-text-style-from-element-h6 wp-block-heading wp-block-paragraph"} >Services</p>
        {" "}
        ...
        <label className={"wp-block-search__label screen-reader-text"} htmlFor={"wp-block-search__input-18"} >Search</label>
        <div className={"wp-block-search__inside-wrapper"} style={{ width: "100%" } as CSSProperties} >
        <input className={"wp-block-search__input has-bbe-small-font-size"} id={"wp-block-search__input-18"} placeholder={"Search..."} value={""} type={"search"} name={"s"} required={true} style={{ borderWidth: "0px", borderStyle: "none" } as CSSProperties} />
      ...
      <dialog className={"demo-panel"} id={"demopanel"} >
        ...
        <span className={"image-wrap"} >
        {" "}
        <img className={"load-on-click"} alt={"Digital agency"} loading={"lazy"} decoding={"async"} data-srcset={"https://the7.io/wp-content/uploads/2026/07/fse-cr-agency.webp 720w, https://the7.io/wp-content/uploads/2026/07/fse-cr-agency-670x1005.webp 670w, https://the7.io/wp-content/uploads/2026/07/fse-cr-agency-335x503.webp 335w"} sizes={"(min-width: 910px) 335px, (min-width: 620px) 395px, calc(100vw - 80px)"} width={"720"} height={"1080"} />
        {" "}
        </span>
        {" "}
      ...
      <svg xmlns={"http://www.w3.org/2000/svg"} viewBox={"0 0 0 0"} width={"0"} height={"0"} focusable={"false"} role={"none"} style={{ visibility: "hidden", position: "absolute", left: "-9999px", overflow: "hidden" } as CSSProperties} >
        <defs >
        <filter id={"wp-duotone-1d273a-f1f5f9-5"} >
      ...
      <svg xmlns={"http://www.w3.org/2000/svg"} viewBox={"0 0 0 0"} width={"0"} height={"0"} focusable={"false"} role={"none"} style={{ visibility: "hidden", position: "absolute", left: "-9999px", overflow: "hidden" } as CSSProperties} >
        <defs >
        <filter id={"wp-duotone-1d273a-f1f5f9-6"} >
        <feColorMatrix color-interpolation-filters={"sRGB"} type={"matrix"} values={" .299 .587 .114 0 0 .299 .587 .114 0 0 .299 .587 .114 0 0 .299 .587 .114 0 0 "} />
        <feComponentTransfer color-interpolation-filters={"sRGB"} >
        <feFuncR type={"table"} tableValues={"0.11372549019608 0.94509803921569"} />
        <feFuncG type={"table"} tableValues={"0.15294117647059 0.96078431372549"} />
      ...
      <svg xmlns={"http://www.w3.org/2000/svg"} viewBox={"0 0 0 0"} width={"0"} height={"0"} focusable={"false"} role={"none"} style={{ visibility: "hidden", position: "absolute", left: "-9999px", overflow: "hidden" } as CSSProperties} >
        <defs >
        <filter id={"wp-duotone-1d273a-f1f5f9-7"} >
        <feColorMatrix color-interpolation-filters={"sRGB"} type={"matrix"} values={" .299 .587 .114 0 0 .299 .587 .114 0 0 .299 .587 .114 0 0 .299 .587 .114 0 0 "} />
        <feComponentTransfer color-interpolation-filters={"sRGB"} >
        <feFuncR type={"table"} tableValues={"0.11372549019608 0.94509803921569"} />
        <feFuncG type={"table"} tableValues={"0.15294117647059 0.96078431372549"} />
      ...
      <svg xmlns={"http://www.w3.org/2000/svg"} viewBox={"0 0 0 0"} width={"0"} height={"0"} focusable={"false"} role={"none"} style={{ visibility: "hidden", position: "absolute", left: "-9999px", overflow: "hidden" } as CSSProperties} >
        <defs >
        <filter id={"wp-duotone-1d273a-f1f5f9-8"} >
        <feColorMatrix color-interpolation-filters={"sRGB"} type={"matrix"} values={" .299 .587 .114 0 0 .299 .587 .114 0 0 .299 .587 .114 0 0 .299 .587 .114 0 0 "} />
        <feComponentTransfer color-interpolation-filters={"sRGB"} >
        <feFuncR type={"table"} tableValues={"0.11372549019608 0.94509803921569"} />
        <feFuncG type={"table"} tableValues={"0.15294117647059 0.96078431372549"} />
      ...
      <svg xmlns={"http://www.w3.org/2000/svg"} viewBox={"0 0 0 0"} width={"0"} height={"0"} focusable={"false"} role={"none"} style={{ visibility: "hidden", position: "absolute", left: "-9999px", overflow: "hidden" } as CSSProperties} >
        <defs >
        <filter id={"wp-duotone-1d273a-f1f5f9-9"} >
        <feColorMatrix color-interpolation-filters={"sRGB"} type={"matrix"} values={" .299 .587 .114 0 0 .299 .587 .114 0 0 .299 .587 .114 0 0 .299 .587 .114 0 0 "} />
        <feComponentTransfer color-interpolation-filters={"sRGB"} >
        <feFuncR type={"table"} tableValues={"0.11372549019608 0.94509803921569"} />
        <feFuncG type={"table"} tableValues={"0.15294117647059 0.96078431372549"} />
      ...
      <svg xmlns={"http://www.w3.org/2000/svg"} viewBox={"0 0 0 0"} width={"0"} height={"0"} focusable={"false"} role={"none"} style={{ visibility: "hidden", position: "absolute", left: "-9999px", overflow: "hidden" } as CSSProperties} >
        <defs >
        <filter id={"wp-duotone-1d273a-f1f5f9-10"} >
        <feColorMatrix color-interpolation-filters={"sRGB"} type={"matrix"} values={" .299 .587 .114 0 0 .299 .587 .114 0 0 .299 .587 .114 0 0 .299 .587 .114 0 0 "} />
        <feComponentTransfer color-interpolation-filters={"sRGB"} >
        <feFuncR type={"table"} tableValues={"0.11372549019608 0.94509803921569"} />
        <feFuncG type={"table"} tableValues={"0.15294117647059 0.96078431372549"} />
      ...
      <svg xmlns={"http://www.w3.org/2000/svg"} viewBox={"0 0 0 0"} width={"0"} height={"0"} focusable={"false"} role={"none"} style={{ visibility: "hidden", position: "absolute", left: "-9999px", overflow: "hidden" } as CSSProperties} >
        <defs >
        <filter id={"wp-duotone-1d273a-f1f5f9-11"} >
        <feColorMatrix color-interpolation-filters={"sRGB"} type={"matrix"} values={" .299 .587 .114 0 0 .299 .587 .114 0 0 .299 .587 .114 0 0 .299 .587 .114 0 0 "} />
        <feComponentTransfer color-interpolation-filters={"sRGB"} >
        <feFuncR type={"table"} tableValues={"0.11372549019608 0.94509803921569"} />
        <feFuncG type={"table"} tableValues={"0.15294117647059 0.96078431372549"} />
      ...
      <svg xmlns={"http://www.w3.org/2000/svg"} viewBox={"0 0 0 0"} width={"0"} height={"0"} focusable={"false"} role={"none"} style={{ visibility: "hidden", position: "absolute", left: "-9999px", overflow: "hidden" } as CSSProperties} >
        <defs >
        <filter id={"wp-duotone-1d273a-f1f5f9-12"} >
        <feColorMatrix color-interpolation-filters={"sRGB"} type={"matrix"} values={" .299 .587 .114 0 0 .299 .587 .114 0 0 .299 .587 .114 0 0 .299 .587 .114 0 0 "} />
        <feComponentTransfer color-interpolation-filters={"sRGB"} >
        <feFuncR type={"table"} tableValues={"0.11372549019608 0.94509803921569"} />
        <feFuncG type={"table"} tableValues={"0.15294117647059 0.96078431372549"} />
      ...
      <svg xmlns={"http://www.w3.org/2000/svg"} viewBox={"0 0 0 0"} width={"0"} height={"0"} focusable={"false"} role={"none"} style={{ visibility: "hidden", position: "absolute", left: "-9999px", overflow: "hidden" } as CSSProperties} >
        <defs >
        <filter id={"wp-duotone-1d273a-f1f5f9-13"} >
        <feColorMatrix color-interpolation-filters={"sRGB"} type={"matrix"} values={" .299 .587 .114 0 0 .299 .587 .114 0 0 .299 .587 .114 0 0 .299 .587 .114 0 0 "} />
        <feComponentTransfer color-interpolation-filters={"sRGB"} >
        <feFuncR type={"table"} tableValues={"0.11372549019608 0.94509803921569"} />
        <feFuncG type={"table"} tableValues={"0.15294117647059 0.96078431372549"} />
      ...
      <svg xmlns={"http://www.w3.org/2000/svg"} viewBox={"0 0 0 0"} width={"0"} height={"0"} focusable={"false"} role={"none"} style={{ visibility: "hidden", position: "absolute", left: "-9999px", overflow: "hidden" } as CSSProperties} >
        <defs >
        <filter id={"wp-duotone-1d273a-f1f5f9-14"} >
        <feColorMatrix color-interpolation-filters={"sRGB"} type={"matrix"} values={" .299 .587 .114 0 0 .299 .587 .114 0 0 .299 .587 .114 0 0 .299 .587 .114 0 0 "} />
        <feComponentTransfer color-interpolation-filters={"sRGB"} >
        <feFuncR type={"table"} tableValues={"0.11372549019608 0.94509803921569"} />
        <feFuncG type={"table"} tableValues={"0.15294117647059 0.96078431372549"} />
      ...
      <svg xmlns={"http://www.w3.org/2000/svg"} viewBox={"0 0 0 0"} width={"0"} height={"0"} focusable={"false"} role={"none"} style={{ visibility: "hidden", position: "absolute", left: "-9999px", overflow: "hidden" } as CSSProperties} >
        <defs >
        <filter id={"wp-duotone-1d273a-f1f5f9-15"} >
        <feColorMatrix color-interpolation-filters={"sRGB"} type={"matrix"} values={" .299 .587 .114 0 0 .299 .587 .114 0 0 .299 .587 .114 0 0 .299 .587 .114 0 0 "} />
        <feComponentTransfer color-interpolation-filters={"sRGB"} >
        <feFuncR type={"table"} tableValues={"0.11372549019608 0.94509803921569"} />
        <feFuncG type={"table"} tableValues={"0.15294117647059 0.96078431372549"} />
      ...
      <svg xmlns={"http://www.w3.org/2000/svg"} viewBox={"0 0 0 0"} width={"0"} height={"0"} focusable={"false"} role={"none"} style={{ visibility: "hidden", position: "absolute", left: "-9999px", overflow: "hidden" } as CSSProperties} >
        <defs >
        <filter id={"wp-duotone-1d273a-f1f5f9-16"} >
        <feColorMatrix color-interpolation-filters={"sRGB"} type={"matrix"} values={" .299 .587 .114 0 0 .299 .587 .114 0 0 .299 .587 .114 0 0 .299 .587 .114 0 0 "} />
        <feComponentTransfer color-interpolation-filters={"sRGB"} >
        <feFuncR type={"table"} tableValues={"0.11372549019608 0.94509803921569"} />
        <feFuncG type={"table"} tableValues={"0.15294117647059 0.96078431372549"} />
      ...
      <svg xmlns={"http://www.w3.org/2000/svg"} viewBox={"0 0 0 0"} width={"0"} height={"0"} focusable={"false"} role={"none"} style={{ visibility: "hidden", position: "absolute", left: "-9999px", overflow: "hidden" } as CSSProperties} >
        <defs >
        <filter id={"wp-duotone-1d273a-f1f5f9-17"} >
        <feColorMatrix color-interpolation-filters={"sRGB"} type={"matrix"} values={" .299 .587 .114 0 0 .299 .587 .114 0 0 .299 .587 .114 0 0 .299 .587 .114 0 0 "} />
        <feComponentTransfer color-interpolation-filters={"sRGB"} >
        <feFuncR type={"table"} tableValues={"0.11372549019608 0.94509803921569"} />
        <feFuncG type={"table"} tableValues={"0.15294117647059 0.96078431372549"} />
