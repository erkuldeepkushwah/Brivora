  ...
  return (
    <>
      ...
      <div className={"wp-site-blocks"} >
        ...
        <h1 className={"has-text-align-left has-link-color alignwide wp-elements-3 wp-block-post-title has-text-color has-bbe-neutral-000-color has-bbe-display-3-font-size wpbbe-55664e1e"} >Account Login</h1>
        </div>
        {" "}
        ...
        {" "}
        <h2 style={{ fontSize: "28px", fontWeight: "700", color: "var(--wp--preset--color--bbe-neutral-900)", marginBottom: "8px" } as CSSProperties} >Welcome back</h2>
        {" "}
        <p style={{ color: "var(--wp--preset--color--bbe-neutral-600)", fontSize: "15px", margin: "0" } as CSSProperties} >Sign in to your account to continue</p>
        {" "}
        </div>
        {" "}
        ...
        {" "}
        <label style={{ display: "block", fontWeight: "600", fontSize: "14px", color: "var(--wp--preset--color--bbe-neutral-900)", marginBottom: "8px" } as CSSProperties} htmlFor={"login-email"} >Email Address</label>
        {" "}
        <input id={"login-email"} type={"email"} required={true} placeholder={"name@company.com"} style={{ width: "100%", padding: "12px 14px", fontSize: "15px", border: "1px solid var(--wp--preset--color--bbe-neutral-300)", borderRadius: "8px", outline: "none", boxSizing: "border-box", transition: "border-color 0.2s" } as CSSProperties} data-hc={[["onfocus","this.style.borderColor='var(--wp--preset--color--bbe-primary-600)'"],["onblur","this.style.borderColor='var(--wp--preset--color--bbe-neutral-300)'"]]} />
        {" "}
        </div>
        {" "}
        <div style={{ marginBottom: "20px" } as CSSProperties} >
        ...
        {" "}
        <label style={{ fontWeight: "600", fontSize: "14px", color: "var(--wp--preset--color--bbe-neutral-900)" } as CSSProperties} htmlFor={"login-password"} >Password</label>
        {" "}
        <a href={"#"} style={{ fontSize: "13px", color: "var(--wp--preset--color--bbe-primary-600)", textDecoration: "none" } as CSSProperties} data-hc={[["onclick","alert('Password reset link has been sent to your email.'); return false;"]]} >Forgot password?</a>
        {" "}
        </div>
        {" "}
        <input id={"login-password"} type={"password"} required={true} placeholder={"••••••••"} style={{ width: "100%", padding: "12px 14px", fontSize: "15px", border: "1px solid var(--wp--preset--color--bbe-neutral-300)", borderRadius: "8px", outline: "none", boxSizing: "border-box", transition: "border-color 0.2s" } as CSSProperties} data-hc={[["onfocus","this.style.borderColor='var(--wp--preset--color--bbe-primary-600)'"],["onblur","this.style.borderColor='var(--wp--preset--color--bbe-neutral-300)'"]]} />
        {" "}
        </div>
        {" "}
        ...
        {" "}
        <label htmlFor={"remember"} style={{ fontSize: "14px", color: "var(--wp--preset--color--bbe-neutral-700)", cursor: "pointer" } as CSSProperties} >Remember me on this device</label>
        {" "}
        </div>
        {" "}
        <button type={"submit"} style={{ width: "100%", padding: "14px", background: "var(--wp--preset--color--bbe-primary-600)", color: "#ffffff", border: "none", borderRadius: "8px", fontSize: "16px", fontWeight: "600", cursor: "pointer", transition: "background 0.2s" } as CSSProperties} data-hc={[["onmouseover","this.style.background='var(--wp--preset--color--bbe-primary-700)'"],["onmouseout","this.style.background='var(--wp--preset--color--bbe-primary-600)'"]]} >{"\n          Sign In\n        "}</button>
        {" "}
        </form>
        {" "}
        <div style={{ textAlign: "center", marginTop: "24px", fontSize: "14px", color: "var(--wp--preset--color--bbe-neutral-600)" } as CSSProperties} >
        {"\n        Don't have an account? "}
        <a href={"/contact"} style={{ color: "var(--wp--preset--color--bbe-primary-600)", fontWeight: "600", textDecoration: "none" } as CSSProperties} >Contact us to get access</a>
        {" "}
        </div>
        {" "}
        </div>
