  ...
  return (
    <>
      ...
      <div className={"wp-site-blocks"} >
        ...
        <h1 className={"has-text-align-left has-link-color alignwide wp-elements-3 wp-block-post-title has-text-color has-bbe-neutral-000-color has-bbe-display-3-font-size wpbbe-55664e1e"} >Our services 2</h1>
        </div>
        {" "}
        ...
        {" "}
        <div className={"wp-block-group alignfull has-global-padding is-layout-constrained wp-container-core-group-is-layout-7283bb6f wp-block-group-is-layout-constrained"} style={{ paddingTop: "var(--wp--preset--spacing--bbe-140)", paddingBottom: "var(--wp--preset--spacing--bbe-160)" } as CSSProperties} >
        {" "}
        <div className={"wp-block-group alignwide is-layout-grid wp-container-core-group-is-layout-bbd33d3c wp-block-group-is-layout-grid"} >
        {" "}
        ...
        {" "}
        <div style={{ "--wp-block-button--hover-background": "var(--wp--preset--color--bbe-primary-700)" } as CSSProperties} className={"wp-block-button is-style-style-2 is-style-style-2--5 has-hover-background"} >
        ...
        <div className={"wp-block-buttons is-content-justification-left is-layout-flex wp-container-core-buttons-is-layout-224084ba wp-block-buttons-is-layout-flex"} >
        {" "}
        <div style={{ "--wp-block-button--hover-background": "var(--wp--preset--color--bbe-primary-700)" } as CSSProperties} className={"wp-block-button is-style-style-2 is-style-style-2--6 has-hover-background"} >
        ...
        {" "}
        <div className={"wp-block-group alignfull has-bbe-neutral-050-background-color has-background has-global-padding is-layout-constrained wp-container-core-group-is-layout-c8232dc1 wp-block-group-is-layout-constrained"} style={{ borderRadius: "0px", paddingTop: "var(--wp--preset--spacing--bbe-160)", paddingBottom: "var(--wp--preset--spacing--bbe-160)" } as CSSProperties} >
        {" "}
        <div className={"wp-block-group alignwide is-horizontal is-content-justification-space-between is-nowrap is-layout-flex wp-container-core-group-is-layout-a83ba19e wp-block-group-is-layout-flex wpbbe-63d09cce"} >
        {" "}
        ...
        {" "}
        <h2 className={"wp-block-heading has-bbe-primary-600-color has-text-color has-link-color wp-elements-4 wpbbe-text-style-from-element-h6"} >Why choose us</h2>
        {" "}
        <h3 className={"wp-block-heading wpbbe-text-style-from-element-h1"} >Expert financial guidance with long-term impact</h3>
        {" "}
        <p className={"wp-block-paragraph"} >
        We work closely with our clients to understand their financial goals and challenges. By combining experience, clear analysis, and practical advice, we help businesses make confident decisions and achieve long-term, measurable results.
        </p>
        {" "}
        </div>
        {" "}
        ...
        {" "}
        <div className={"wp-block-group is-content-justification-space-between is-nowrap is-layout-flex wp-container-core-group-is-layout-97321954 wp-block-group-is-layout-flex wpbbe-26ce92ec"} style={{ borderTopLeftRadius: "0px", borderTopRightRadius: "0px", borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px", borderLeftColor: "var(--wp--preset--color--bbe-primary-200)", borderLeftWidth: "1px", minHeight: "0px", paddingTop: "0", paddingBottom: "0", paddingLeft: "var(--wp--preset--spacing--bbe-70)" } as CSSProperties} >
        ...
        {" "}
        <h3 className={"wp-block-heading has-text-align-left wpbbe-text-style-from-element-h4"} >Experienced financial specialists</h3>
        {" "}
        <p className={"has-text-align-left wp-block-paragraph"} >We bring financial expertise and practical experience to support informed decisions and growth.</p>
        {" "}
        </div>
        {" "}
        </div>
        {" "}
        <div className={"wp-block-group is-content-justification-space-between is-nowrap is-layout-flex wp-container-core-group-is-layout-97321954 wp-block-group-is-layout-flex wpbbe-1982e6b9"} style={{ borderTopLeftRadius: "0px", borderTopRightRadius: "0px", borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px", borderLeftColor: "var(--wp--preset--color--bbe-primary-200)", borderLeftWidth: "1px", minHeight: "0px", paddingTop: "0", paddingBottom: "0", paddingLeft: "var(--wp--preset--spacing--bbe-70)" } as CSSProperties} >
        <div className={"wpbbe-svg-icon wpbbe-eaf673e3 wp-block-wpbbe-svg-inline wpbbe-flex-item-prevent-shrinking"} >
        <div className={"svg-wrapper"} >
        {/* ?xml version="1.0" encoding="UTF-8"? */}
        {" "}
        <svg aria-hidden={"true"} focusable={"false"} xmlns={"http://www.w3.org/2000/svg"} id={"Layer_1"} data-name={"Layer 1"} viewBox={"0 0 24 24"} strokeWidth={"1"} width={"24"} height={"24"} color={"#000000"} >
        ...
        <div className={"wp-block-group wp-container-content-9cfa9a5a is-layout-flow wp-container-core-group-is-layout-add8a69b wp-block-group-is-layout-flow"} >
        {" "}
        <h3 className={"wp-block-heading has-text-align-left wpbbe-text-style-from-element-h4"} >Practical, cost-effective solutions</h3>
        {" "}
        <p className={"has-text-align-left wp-block-paragraph"} >We deliver tailored advisory services that use resources efficiently while maximizing long-term value.</p>
        {" "}
        </div>
        {" "}
        </div>
        {" "}
        <div className={"wp-block-group is-content-justification-space-between is-nowrap is-layout-flex wp-container-core-group-is-layout-97321954 wp-block-group-is-layout-flex wpbbe-87a18789"} style={{ borderTopLeftRadius: "0px", borderTopRightRadius: "0px", borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px", borderLeftColor: "var(--wp--preset--color--bbe-primary-200)", borderLeftWidth: "1px", minHeight: "0px", paddingTop: "0", paddingBottom: "0", paddingLeft: "var(--wp--preset--spacing--bbe-70)" } as CSSProperties} >
        ...
        <div className={"wp-block-group wp-container-content-9cfa9a5a is-layout-flow wp-container-core-group-is-layout-add8a69b wp-block-group-is-layout-flow"} >
        {" "}
        <h3 className={"wp-block-heading has-text-align-left wpbbe-text-style-from-element-h4"} >Trusted, client-focused approach</h3>
        {" "}
        <p className={"has-text-align-left wp-block-paragraph"} >We build long-term partnerships by focusing on transparency, collaboration, and dependable outcomes.</p>
        {" "}
        </div>
        {" "}
        </div>
        ...
        {" "}
        <div className={"wp-block-group alignfull has-global-padding is-layout-constrained wp-container-core-group-is-layout-b04fef7e wp-block-group-is-layout-constrained"} style={{ paddingTop: "var(--wp--preset--spacing--bbe-160)", paddingBottom: "var(--wp--preset--spacing--bbe-160)" } as CSSProperties} >
        {" "}
        <div className={"wp-block-group alignwide has-global-padding is-layout-constrained wp-container-core-group-is-layout-8a77120b wp-block-group-is-layout-constrained"} >
        {" "}
        <h2 className={"wp-block-heading has-text-align-center has-bbe-primary-600-color has-text-color has-link-color wp-elements-5 wpbbe-text-style-from-element-h6"} >Our consulting process</h2>
        {" "}
        <h3 className={"wp-block-heading has-text-align-center wpbbe-text-style-from-element-h1"} >A clear, structured approach to financial decision-making</h3>
        {" "}
        </div>
        {" "}
        <div className={"wp-block-group alignwide is-layout-grid wp-container-core-group-is-layout-e9164392 wp-block-group-is-layout-grid"} >
        {" "}
        <div className={"wp-block-group has-bbe-neutral-100-background-color has-background wp-container-content-c558feb1 is-layout-flow wp-container-core-group-is-layout-e0cb0d67 wp-block-group-is-layout-flow"} style={{ minHeight: "0px", paddingTop: "var(--wp--preset--spacing--bbe-80)", paddingRight: "var(--wp--preset--spacing--bbe-80)", paddingBottom: "var(--wp--preset--spacing--bbe-90)", paddingLeft: "var(--wp--preset--spacing--bbe-80)" } as CSSProperties} >
        {" "}
        <p className={"has-bbe-primary-600-color has-text-color has-link-color wp-elements-6 wp-container-content-f725d059 wpbbe-text-style-from-element-h2 wp-block-heading wp-block-paragraph"} style={{ lineHeight: "1" } as CSSProperties} >1.</p>
        {" "}
        <div className={"wp-block-group wp-container-content-9cfa9a5a is-layout-flow wp-container-core-group-is-layout-e562acab wp-block-group-is-layout-flow"} >
        {" "}
        <h3 className={"wp-block-heading wp-container-content-a5fc19f1"} >Business & financial assessment</h3>
        {" "}
        <p className={"wp-container-content-9cfa9a5a wp-block-paragraph"} >
        We begin by understanding your business, financial position, and objectives through a review of financial data, performance indicators, and key challenges.
        </p>
        {" "}
        </div>
        {" "}
        ...
        <div className={"wp-block-group has-bbe-neutral-100-background-color has-background wp-container-content-c558feb1 is-layout-flow wp-container-core-group-is-layout-e0cb0d67 wp-block-group-is-layout-flow"} style={{ minHeight: "0px", paddingTop: "var(--wp--preset--spacing--bbe-80)", paddingRight: "var(--wp--preset--spacing--bbe-80)", paddingBottom: "var(--wp--preset--spacing--bbe-90)", paddingLeft: "var(--wp--preset--spacing--bbe-80)" } as CSSProperties} >
        {" "}
        <p className={"has-bbe-primary-600-color has-text-color has-link-color wp-elements-7 wp-container-content-f725d059 wpbbe-text-style-from-element-h2 wp-block-heading wp-block-paragraph"} style={{ lineHeight: "1" } as CSSProperties} >2.</p>
        {" "}
        <div className={"wp-block-group wp-container-content-9cfa9a5a is-layout-flow wp-container-core-group-is-layout-e562acab wp-block-group-is-layout-flow"} >
        {" "}
        <h3 className={"wp-block-heading wp-container-content-a5fc19f1"} >Goals & strategy definition</h3>
        {" "}
        <p className={"wp-container-content-9cfa9a5a wp-block-paragraph"} >
        Together, we define clear financial goals and priorities. We develop a strategy aligned with your business needs, market conditions, and risk profile.
        </p>
        {" "}
        </div>
        {" "}
        ...
        <div className={"wp-block-group has-bbe-neutral-100-background-color has-background wp-container-content-c558feb1 is-layout-flow wp-container-core-group-is-layout-e0cb0d67 wp-block-group-is-layout-flow"} style={{ minHeight: "0px", paddingTop: "var(--wp--preset--spacing--bbe-80)", paddingRight: "var(--wp--preset--spacing--bbe-80)", paddingBottom: "var(--wp--preset--spacing--bbe-90)", paddingLeft: "var(--wp--preset--spacing--bbe-80)" } as CSSProperties} >
        {" "}
        <p className={"has-bbe-primary-600-color has-text-color has-link-color wp-elements-8 wp-container-content-f725d059 wpbbe-text-style-from-element-h2 wp-block-heading wp-block-paragraph"} style={{ lineHeight: "1" } as CSSProperties} >3.</p>
        {" "}
        <div className={"wp-block-group wp-container-content-9cfa9a5a is-layout-flow wp-container-core-group-is-layout-e562acab wp-block-group-is-layout-flow"} >
        {" "}
        <h3 className={"wp-block-heading wp-container-content-a5fc19f1"} >Financial planning & modeling</h3>
        {" "}
        <p className={"wp-container-content-9cfa9a5a wp-block-paragraph"} >
        We create detailed financial plans, forecasts, and scenarios to support decision-making and evaluate opportunities before implementation.
        </p>
        {" "}
        </div>
        {" "}
        ...
        <div className={"wp-block-group has-bbe-neutral-100-background-color has-background wp-container-content-c558feb1 is-layout-flow wp-container-core-group-is-layout-e0cb0d67 wp-block-group-is-layout-flow"} style={{ minHeight: "0px", paddingTop: "var(--wp--preset--spacing--bbe-80)", paddingRight: "var(--wp--preset--spacing--bbe-80)", paddingBottom: "var(--wp--preset--spacing--bbe-90)", paddingLeft: "var(--wp--preset--spacing--bbe-80)" } as CSSProperties} >
        {" "}
        <p className={"has-bbe-primary-600-color has-text-color has-link-color wp-elements-9 wp-container-content-f725d059 wpbbe-text-style-from-element-h2 wp-block-heading wp-block-paragraph"} style={{ lineHeight: "1" } as CSSProperties} >4.</p>
        {" "}
        <div className={"wp-block-group wp-container-content-9cfa9a5a is-layout-flow wp-container-core-group-is-layout-e562acab wp-block-group-is-layout-flow"} >
        {" "}
        <h3 className={"wp-block-heading wp-container-content-a5fc19f1"} >Execution & implementation support</h3>
        {" "}
        <p className={"wp-container-content-9cfa9a5a wp-block-paragraph"} >
        We support the implementation of agreed strategies, working closely with your team to ensure actions are practical, timely, and effective.
        </p>
        {" "}
        </div>
        {" "}
        ...
        <div className={"wp-block-group has-bbe-neutral-100-background-color has-background wp-container-content-c558feb1 is-layout-flow wp-container-core-group-is-layout-e0cb0d67 wp-block-group-is-layout-flow"} style={{ minHeight: "0px", paddingTop: "var(--wp--preset--spacing--bbe-80)", paddingRight: "var(--wp--preset--spacing--bbe-80)", paddingBottom: "var(--wp--preset--spacing--bbe-90)", paddingLeft: "var(--wp--preset--spacing--bbe-80)" } as CSSProperties} >
        {" "}
        <p className={"has-bbe-primary-600-color has-text-color has-link-color wp-elements-10 wp-container-content-f725d059 wpbbe-text-style-from-element-h2 wp-block-heading wp-block-paragraph"} style={{ lineHeight: "1" } as CSSProperties} >5.</p>
        {" "}
        <div className={"wp-block-group wp-container-content-9cfa9a5a is-layout-flow wp-container-core-group-is-layout-e562acab wp-block-group-is-layout-flow"} >
        {" "}
        <h3 className={"wp-block-heading wp-container-content-a5fc19f1"} >Monitoring & ongoing advisory</h3>
        {" "}
        <p className={"wp-container-content-9cfa9a5a wp-block-paragraph"} >
        We track performance, review results, and adjust strategies as needed, providing ongoing advice to support sustainable growth.
        </p>
        {" "}
        </div>
        {" "}
        ...
        {" "}
        <div className={"wp-block-group alignfull has-bbe-primary-950-background-color has-background is-vertical is-content-justification-center is-layout-flex wp-container-core-group-is-layout-139f9196 wp-block-group-is-layout-flex aos-root"} style={{ minHeight: "240px", paddingTop: "var(--wp--preset--spacing--bbe-100)", paddingRight: "var(--wp--preset--spacing--bbe-80)", paddingBottom: "var(--wp--preset--spacing--bbe-100)", paddingLeft: "var(--wp--preset--spacing--bbe-80)", backgroundImage: "url('https://the7.io/fse-business/wp-content/uploads/sites/133/2026/05/art-side-b-r.svg')", backgroundPosition: "100% 100%", backgroundSize: "cover" } as CSSProperties} >
        {" "}
        <h3 data-aos-easing={"ease-out"} data-aos={"slide-up"} className={"wp-block-heading has-text-align-center alignwide has-bbe-neutral-000-color has-text-color has-link-color wp-elements-11 wpbbe-6f38849f"} >
        <span style={{ backgroundImage: "var(--wp--preset--gradient--bbe-gradient-2)", animationName: "text-bg-animate-h", animationDuration: "5s" } as CSSProperties} className={"text-with-gradient"} >Ready to get started?</span>
        </h3>
        {" "}
        <p data-aos-easing={"ease-out"} data-aos={"fade-in"} className={"has-text-align-center has-bbe-neutral-000-color has-text-color has-link-color wp-elements-12 wpbbe-400f4bd9 wp-block-paragraph"} >Schedule a consultation with our finance experts to discuss your goals, challenges, and opportunities for growth.</p>
        {" "}
        <div data-aos-easing={"ease-out"} data-aos={"fade-in"} className={"wp-block-buttons alignwide is-content-justification-center is-layout-flex wp-container-core-buttons-is-layout-a60a5c53 wp-block-buttons-is-layout-flex wpbbe-5b315532"} style={{ marginTop: "var(--wp--preset--spacing--bbe-30)" } as CSSProperties} >
        {" "}
        <div style={{ "--wp-block-button--hover-background": "var(--wp--preset--color--bbe-primary-700)" } as CSSProperties} className={"wp-block-button is-style-bbe-secondary-500 is-style-fill has-hover-background"} >
        ...
        {" "}
        <p className={"has-bbe-neutral-900-color has-text-color has-link-color wp-elements-13 wpbbe-text-style-from-element-h5 wp-block-heading wp-block-paragraph"} >
        <mark style={{ backgroundColor: "rgba(0, 0, 0, 0)" } as CSSProperties} className={"has-inline-color has-bbe-primary-600-color"} >Call:</mark>
        {" +1-001-234-5678"}
        </p>
        {" "}
        ...
        {" "}
        <p className={"has-bbe-neutral-900-color has-text-color has-link-color wp-elements-14 wpbbe-text-style-from-element-h6 wp-block-heading wp-block-paragraph"} >Info</p>
        {" "}
        ...
        <div className={"wp-block-group is-layout-flow wp-container-core-group-is-layout-2d0a040d wp-block-group-is-layout-flow"} >
        {" "}
        <p className={"has-bbe-neutral-900-color has-text-color has-link-color wp-elements-15 wpbbe-text-style-from-element-h6 wp-block-heading wp-block-paragraph"} >Services</p>
        {" "}
        ...
        <label className={"wp-block-search__label screen-reader-text"} htmlFor={"wp-block-search__input-11"} >Search</label>
        <div className={"wp-block-search__inside-wrapper"} style={{ width: "100%" } as CSSProperties} >
        <input className={"wp-block-search__input has-bbe-small-font-size"} id={"wp-block-search__input-11"} placeholder={"Search..."} defaultValue={""} type={"search"} name={"s"} required={true} style={{ borderWidth: "0px", borderStyle: "none" } as CSSProperties} />
