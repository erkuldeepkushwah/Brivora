  ...
  return (
    <>
      ...
      <div className={"wp-site-blocks"} >
        ...
        <input size={40} maxLength={400} className={"wpcf7-form-control wpcf7-text wpcf7-validates-as-required"} autoComplete={"name"} aria-required={"true"} aria-invalid={"false"} value={""} type={"text"} name={"your-name"} />
        </span>
        {" "}
        </label>
        {" "}
        ...
        <input size={40} maxLength={400} className={"wpcf7-form-control wpcf7-email wpcf7-validates-as-required wpcf7-text wpcf7-validates-as-email"} autoComplete={"email"} aria-required={"true"} aria-invalid={"false"} value={""} type={"email"} name={"your-email"} />
        </span>
        {" "}
        </label>
        {" "}
        ...
        <input size={40} maxLength={400} className={"wpcf7-form-control wpcf7-tel wpcf7-text wpcf7-validates-as-tel"} autoComplete={"tel"} aria-invalid={"false"} value={""} type={"tel"} name={"tel-814"} />
        </span>
        {" "}
        </label>
        {" "}
        ...
        <input size={40} maxLength={400} className={"wpcf7-form-control wpcf7-text wpcf7-validates-as-required"} autoComplete={"company"} aria-required={"true"} aria-invalid={"false"} value={""} type={"text"} name={"company"} />
        </span>
        {" "}
        </label>
        {" "}
