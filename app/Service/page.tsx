  ...
  return (
    <>
      ...
      <div className={"wp-site-blocks"} >
        ...
        <input className={"wp-block-search__input has-bbe-small-font-size"} id={"wp-block-search__input-11"} placeholder={"Search..."} value={""} type={"search"} name={"s"} required={true} style={{ borderWidth: "0px", borderStyle: "none" } as CSSProperties} />
