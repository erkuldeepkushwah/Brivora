...
export default function ContactPage() {
  return (
    <>
      ...
      <link rel="stylesheet" href={"https://the7.io/fse-business/wp-content/plugins/better-block-editor-pro-kit/dist/blocks/contact-form-7/style-index.css?ver=7.1"} />
      ...
      <div className={"wp-site-blocks"} >
        ...
        <h1 className={"has-text-align-left has-link-color alignwide wp-elements-3 wp-block-post-title has-text-color has-bbe-neutral-000-color has-bbe-display-3-font-size wpbbe-55664e1e"} >Contact 1</h1>
        </div>
        {" "}
        ...
        {" "}
        <div className={"wp-block-group alignfull has-global-padding is-layout-constrained wp-container-core-group-is-layout-82845393 wp-block-group-is-layout-constrained"} style={{ paddingTop: "var(--wp--preset--spacing--bbe-160)", paddingBottom: "var(--wp--preset--spacing--bbe-160)" } as CSSProperties} >
        {" "}
        <div className={"wp-block-group alignwide is-horizontal is-content-justification-space-between is-nowrap is-layout-flex wp-container-core-group-is-layout-a6c7ea50 wp-block-group-is-layout-flex wpbbe-90129738"} >
        {" "}
        ...
        {" "}
        <h2 className={"wp-block-heading has-text-align-left has-bbe-primary-600-color has-text-color has-link-color wp-elements-4 wpbbe-text-style-from-element-h6"} >Get in touch</h2>
        {" "}
        <h3 className={"wp-block-heading wpbbe-text-style-from-element-h1"} >Let’s choose the best solution for your business!</h3>
        {" "}
        <div className={"wp-block-group is-layout-flow wp-container-core-group-is-layout-698ddd92 wp-block-group-is-layout-flow"} style={{ marginTop: "var(--wp--preset--spacing--bbe-90)", marginBottom: "var(--wp--preset--spacing--bbe-90)", paddingTop: "0", paddingRight: "0", paddingBottom: "0", paddingLeft: "0" } as CSSProperties} >
        {" "}
        ...
        {" "}
        <p className={"has-bbe-primary-600-color has-text-color has-link-color wp-elements-5 wp-block-paragraph"} style={{ fontStyle: "normal", fontWeight: "500", lineHeight: "1.4" } as CSSProperties} >Call us</p>
        {" "}
        <p className={"has-bbe-neutral-900-color has-text-color has-link-color has-bbe-2-x-large-font-size wp-elements-6 wpbbe-text-style-from-element-h4 wp-block-heading wp-block-paragraph"} style={{ fontStyle: "normal", fontWeight: "500", lineHeight: "1.2" } as CSSProperties} >+1-001-234-5678</p>
        {" "}
        </div>
        {" "}
        <div className={"wp-block-group is-layout-flow wp-container-core-group-is-layout-b27d416c wp-block-group-is-layout-flow"} style={{ borderTopLeftRadius: "0px", borderTopRightRadius: "0px", borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px", borderLeftColor: "var(--wp--preset--color--bbe-primary-200)", borderLeftWidth: "1px", paddingLeft: "var(--wp--preset--spacing--bbe-40)" } as CSSProperties} >
        {" "}
        <p className={"has-bbe-primary-600-color has-text-color has-link-color wp-elements-7 wp-block-paragraph"} style={{ fontStyle: "normal", fontWeight: "500", lineHeight: "1.4" } as CSSProperties} >Email</p>
        {" "}
        <p className={"wp-elements-8 wp-block-paragraph"} style={{ lineHeight: "1.4" } as CSSProperties} >info@mywebsite.com</p>
        {" "}
        </div>
        {" "}
        <div className={"wp-block-group is-layout-flow wp-container-core-group-is-layout-b27d416c wp-block-group-is-layout-flow"} style={{ borderTopLeftRadius: "0px", borderTopRightRadius: "0px", borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px", borderLeftColor: "var(--wp--preset--color--bbe-primary-200)", borderLeftWidth: "1px", paddingLeft: "var(--wp--preset--spacing--bbe-40)" } as CSSProperties} >
        {" "}
        <p className={"has-bbe-primary-600-color has-text-color has-link-color wp-elements-9 wp-block-paragraph"} style={{ fontStyle: "normal", fontWeight: "500", lineHeight: "1.4" } as CSSProperties} >Location</p>
        {" "}
        ...
        <div className={"wp-block-group is-layout-flow wp-container-core-group-is-layout-b27d416c wp-block-group-is-layout-flow"} style={{ borderTopLeftRadius: "0px", borderTopRightRadius: "0px", borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px", borderLeftColor: "var(--wp--preset--color--bbe-primary-200)", borderLeftWidth: "1px", paddingLeft: "var(--wp--preset--spacing--bbe-40)" } as CSSProperties} >
        {" "}
        <p className={"has-bbe-primary-600-color has-text-color has-link-color wp-elements-11 wp-block-paragraph"} style={{ fontStyle: "normal", fontWeight: "500", lineHeight: "1.4" } as CSSProperties} >Business hours</p>
        {" "}
        <p className={"wp-elements-12 wp-block-paragraph"} style={{ lineHeight: "1.4" } as CSSProperties} >Monday to Friday: 9 am – 5 pm</p>
        {" "}
        </div>
        {" "}
        </div>
        {" "}
        <ul className={"wp-block-social-links has-normal-icon-size has-icon-color has-icon-background-color is-style-default is-layout-flex wp-container-core-social-links-is-layout-f6cff578 wp-block-social-links-is-layout-flex"} >
        <li style={{ color: "#ffffff", backgroundColor: "#165dfc" } as CSSProperties} className={"wp-social-link wp-social-link-x has-bbe-neutral-000-color has-bbe-primary-600-background-color wp-block-social-link"} >
        ...
        {" "}
        <li style={{ color: "#ffffff", backgroundColor: "#165dfc" } as CSSProperties} className={"wp-social-link wp-social-link-facebook has-bbe-neutral-000-color has-bbe-primary-600-background-color wp-block-social-link"} >
        <a rel={"noopener nofollow"} target={"_blank"} href={"#"} className={"wp-block-social-link-anchor"} >
        <svg width={"24"} height={"24"} viewBox={"0 0 24 24"} version={"1.1"} xmlns={"http://www.w3.org/2000/svg"} aria-hidden={"true"} focusable={"false"} >
        ...
        {" "}
        <li style={{ color: "#ffffff", backgroundColor: "#165dfc" } as CSSProperties} className={"wp-social-link wp-social-link-youtube has-bbe-neutral-000-color has-bbe-primary-600-background-color wp-block-social-link"} >
        <a rel={"noopener nofollow"} target={"_blank"} href={"#"} className={"wp-block-social-link-anchor"} >
        <svg width={"24"} height={"24"} viewBox={"0 0 24 24"} version={"1.1"} xmlns={"http://www.w3.org/2000/svg"} aria-hidden={"true"} focusable={"false"} >
        ...
        {" "}
        <li style={{ color: "#ffffff", backgroundColor: "#165dfc" } as CSSProperties} className={"wp-social-link wp-social-link-instagram has-bbe-neutral-000-color has-bbe-primary-600-background-color wp-block-social-link"} >
        <a rel={"noopener nofollow"} target={"_blank"} href={"#"} className={"wp-block-social-link-anchor"} >
        <svg width={"24"} height={"24"} viewBox={"0 0 24 24"} version={"1.1"} xmlns={"http://www.w3.org/2000/svg"} aria-hidden={"true"} focusable={"false"} >
        ...
        {" "}
        <div className={"wp-block-group has-bbe-neutral-100-background-color has-background is-layout-flow wp-container-core-group-is-layout-badb6b3a wp-block-group-is-layout-flow wpbbe-25f611b2"} style={{ paddingTop: "var(--wp--preset--spacing--bbe-100)", paddingRight: "var(--wp--preset--spacing--bbe-100)", paddingBottom: "var(--wp--preset--spacing--bbe-100)", paddingLeft: "var(--wp--preset--spacing--bbe-100)" } as CSSProperties} >
        {" "}
        <h3 className={"wp-block-heading wpbbe-text-style-from-element-h3"} >Need consultation?</h3>
        {" "}
        <p className={"wp-block-paragraph"} >Send your query or request a callback and our specialist will get back to you shortly.</p>
        {" "}
        ...
        {" "}
        <div className={"wpcf7 no-js"} id={"wpcf7-f17635-p81-o1"} lang={"en-US"} dir={"ltr"} data-wpcf7-id={"17635"} >
        {" "}
        ...
        {" "}
        <form action={"/fse-business/contact/#wpcf7-f17635-p81-o1"} method={"post"} className={"wpcf7-form init demo"} aria-label={"Contact form"} noValidate={true} data-status={"init"} >
        {" "}
        ...
        <input type={"hidden"} name={"_wpcf7_unit_tag"} value={"wpcf7-f17635-p81-o1"} />
        ...
        <input size={40} maxLength={400} className={"wpcf7-form-control wpcf7-text wpcf7-validates-as-required"} autoComplete={"name"} aria-required={"true"} aria-invalid={"false"} defaultValue={""} type={"text"} name={"your-name"} />
        </span>
        {" "}
        </label>
        {" "}
        ...
        <input size={40} maxLength={400} className={"wpcf7-form-control wpcf7-email wpcf7-validates-as-required wpcf7-text wpcf7-validates-as-email"} autoComplete={"email"} aria-required={"true"} aria-invalid={"false"} defaultValue={""} type={"email"} name={"your-email"} />
        </span>
        {" "}
        </label>
        {" "}
        ...
        <br />
        {" "}
        <span className={"wpcf7-form-control-wrap"} data-name={"tel-814"} >
        <input size={40} maxLength={400} className={"wpcf7-form-control wpcf7-tel wpcf7-text wpcf7-validates-as-tel"} autoComplete={"tel"} aria-invalid={"false"} defaultValue={""} type={"tel"} name={"tel-814"} />
        </span>
        {" "}
        </label>
        {" "}
        ...
        <input size={40} maxLength={400} className={"wpcf7-form-control wpcf7-text wpcf7-validates-as-required"} autoComplete={"company"} aria-required={"true"} aria-invalid={"false"} defaultValue={""} type={"text"} name={"company"} />
        </span>
        {" "}
        </label>
        {" "}
        ...
        <textarea cols={40} rows={4} maxLength={2000} className={"wpcf7-form-control wpcf7-textarea"} aria-invalid={"false"} name={"your-message"} />
        </span>
        {" "}
        </label>
        {" "}
        ...
        {" "}
        <p >
        <span className={"wpcf7-form-control-wrap"} data-name={"acceptance-17"} >
        <span className={"wpcf7-form-control wpcf7-acceptance"} >
        <span className={"wpcf7-list-item"} >
        <label >
        <input type={"checkbox"} name={"acceptance-17"} value={"1"} aria-invalid={"false"} />
        <span className={"wpcf7-list-item-label"} >I agree to the privacy policy and terms of service.</span>
        </label>
        </span>
        </span>
        </span>
