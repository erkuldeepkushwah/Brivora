...
export const metadata = { title: "Contact 1 – Block Editor Business" };
...
export default function ContactPage() {
  return (
    <>
      ...
      <link rel="alternate" title="JSON" type="application/json" href="https://the7.io/fse-business/wp-json/wp/v2/pages/81" />
            ...
            <div className="wp-block-group alignwide is-horizontal is-content-justification-space-between is-nowrap is-layout-flex wp-container-core-group-is-layout-a6c7ea50 wp-block-group-is-layout-flex wpbbe-90129738">
              <div className="wp-block-group wp-container-content-0733e5d0 has-global-padding is-layout-constrained wp-container-core-group-is-layout-8f854688 wp-block-group-is-layout-constrained" style={{ paddingTop: "var(--wp--preset--spacing--0)", paddingRight: "var(--wp--preset--spacing--0)", paddingBottom: "var(--wp--preset--spacing--0)", paddingLeft: "var(--wp--preset--spacing--0)" } as CSSProperties}>
                ...
                <h3 className="wp-block-heading wpbbe-text-style-from-element-h1">
                  {`Let’s choose the best solution for your business!`}
                </h3>
                <div className="wp-block-group is-layout-flow wp-container-core-group-is-layout-698ddd92 wp-block-group-is-layout-flow" style={{ marginTop: "var(--wp--preset--spacing--bbe-90)", marginBottom: "var(--wp--preset--spacing--bbe-90)", paddingTop: "0", paddingRight: "0", paddingBottom: "0", paddingLeft: "0" } as CSSProperties}>
                  <div className="wp-block-group is-layout-flow wp-container-core-group-is-layout-b27d416c wp-block-group-is-layout-flow" style={{ borderTopLeftRadius: "0px", borderTopRightRadius: "0px", borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px", borderLeftColor: "var(--wp--preset--color--bbe-primary-200)", borderLeftWidth: "1px", paddingLeft: "var(--wp--preset--spacing--bbe-40)" } as CSSProperties}>
                    <p className="has-bbe-primary-600-color has-text-color has-link-color wp-elements-5 wp-block-paragraph" style={{ fontStyle: "normal", fontWeight: "500", lineHeight: "1.4" } as CSSProperties}>
                      {`Call us`}
                    </p>
                  ...
                  <div className="wp-block-group is-layout-flow wp-container-core-group-is-layout-b27d416c wp-block-group-is-layout-flow" style={{ borderTopLeftRadius: "0px", borderTopRightRadius: "0px", borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px", borderLeftColor: "var(--wp--preset--color--bbe-primary-200)", borderLeftWidth: "1px", paddingLeft: "var(--wp--preset--spacing--bbe-40)" } as CSSProperties}>
                    <p className="has-bbe-primary-600-color has-text-color has-link-color wp-elements-7 wp-block-paragraph" style={{ fontStyle: "normal", fontWeight: "500", lineHeight: "1.4" } as CSSProperties}>
                      {`Email`}
                    </p>
                  ...
                  <div className="wp-block-group is-layout-flow wp-container-core-group-is-layout-b27d416c wp-block-group-is-layout-flow" style={{ borderTopLeftRadius: "0px", borderTopRightRadius: "0px", borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px", borderLeftColor: "var(--wp--preset--color--bbe-primary-200)", borderLeftWidth: "1px", paddingLeft: "var(--wp--preset--spacing--bbe-40)" } as CSSProperties}>
                    <p className="has-bbe-primary-600-color has-text-color has-link-color wp-elements-9 wp-block-paragraph" style={{ fontStyle: "normal", fontWeight: "500", lineHeight: "1.4" } as CSSProperties}>
                      {`Location`}
                    </p>
                  ...
                  <div className="wp-block-group is-layout-flow wp-container-core-group-is-layout-b27d416c wp-block-group-is-layout-flow" style={{ borderTopLeftRadius: "0px", borderTopRightRadius: "0px", borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px", borderLeftColor: "var(--wp--preset--color--bbe-primary-200)", borderLeftWidth: "1px", paddingLeft: "var(--wp--preset--spacing--bbe-40)" } as CSSProperties}>
                    <p className="has-bbe-primary-600-color has-text-color has-link-color wp-elements-11 wp-block-paragraph" style={{ fontStyle: "normal", fontWeight: "500", lineHeight: "1.4" } as CSSProperties}>
                      {`Business hours`}
                    </p>
                    <p className="wp-elements-12 wp-block-paragraph" style={{ lineHeight: "1.4" } as CSSProperties}>
              ...
              <div className="wp-block-group wp-container-content-0733e5d0 has-global-padding is-layout-constrained wp-container-core-group-is-layout-7096330c wp-block-group-is-layout-constrained" style={{ paddingTop: "var(--wp--preset--spacing--0)", paddingRight: "var(--wp--preset--spacing--0)", paddingBottom: "var(--wp--preset--spacing--0)", paddingLeft: "var(--wp--preset--spacing--0)" } as CSSProperties}>
                <div className="wp-block-group has-bbe-neutral-100-background-color has-background is-layout-flow wp-container-core-group-is-layout-badb6b3a wp-block-group-is-layout-flow wpbbe-25f611b2" style={{ paddingTop: "var(--wp--preset--spacing--bbe-100)", paddingRight: "var(--wp--preset--spacing--bbe-100)", paddingBottom: "var(--wp--preset--spacing--bbe-100)", paddingLeft: "var(--wp--preset--spacing--bbe-100)" } as CSSProperties}>
                  ...
                  <p className="wp-block-paragraph">
                    {`Send your query or request a callback and our specialist will get back to you shortly.`}
                  </p>
                  <div className="wpbbe-70c19d1c has-stretch-all wp-block-wpbbe-contact-form-7 has-bbe-x-small-font-size has-wpbbe-cf7-styles">
                    <div className="wpcf7 no-js" id="wpcf7-f17635-p81-o1" lang="en-US" dir="ltr" data-wpcf7-id="17635">
                      ...
                      <form action="/fse-business/contact/#wpcf7-f17635-p81-o1" method="post" className="wpcf7-form init demo" aria-label="Contact form" noValidate data-status="init">
                        ...
                        <p>
                          <label>
                            ...
                            <span className="wpcf7-form-control-wrap" data-name="your-message">
                              <textarea cols={40} rows={4} maxLength={2000} className="wpcf7-form-control wpcf7-textarea" aria-invalid="false" name="your-message"></textarea>
                            </span>
                          </label>
                        </p>
                        <p>
