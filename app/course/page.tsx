...
export default function CoursePage() {
  return (
    <>
      ...
      <link rel="alternate" title="oEmbed (JSON)" type="application/json+oembed" href="https://the7.io/fse-business/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fthe7.io%2Ffse-business%2Fmore%2Fcase-cards%2F" />
      <link rel="alternate" title="oEmbed (XML)" type="text/xml+oembed" href="https://the7.io/fse-business/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fthe7.io%2Ffse-business%2Fmore%2Fcase-cards%2F&format=xml" />
      ...
      <link rel="alternate" title="JSON" type="application/json" href="https://the7.io/fse-business/wp-json/wp/v2/pages/19051" />
      <link rel="EditURI" type="application/rsd+xml" title="RSD" href="https://the7.io/fse-business/xmlrpc.php?rsd" />
      <link rel="canonical" href="https://the7.io/fse-business/more/case-cards/" />
      <link rel="shortlink" href="https://the7.io/fse-business/?p=19051" />
                ...
                <li className="wp-block-post post-16597 case type-case status-publish has-post-thumbnail hentry case_category-category-2">
                  <div className="wp-block-group has-global-padding is-layout-constrained wp-container-core-group-is-layout-7096330c wp-block-group-is-layout-constrained" style={{ paddingTop: "var(--wp--preset--spacing--0)", paddingRight: "var(--wp--preset--spacing--0)", paddingBottom: "var(--wp--preset--spacing--0)", paddingLeft: "var(--wp--preset--spacing--0)" } as CSSProperties}>
                    <div data-hover-animation="true" data-hover-easing="ease-out" className="wp-block-cover has-custom-content-position is-position-bottom-center wpbbe-1ffa082a" style={{ minHeight: "380px", aspectRatio: "unset" } as CSSProperties}>
                      <span aria-hidden="true" className="wp-block-cover__background has-background-dim-70 has-background-dim has-background-gradient" style={{ background: "linear-gradient(20deg,rgb(0,0,0) 50%,rgba(0,0,0,0) 100%)" } as CSSProperties}></span>
          ...
          <div className="wp-block-group has-bbe-neutral-050-background-color has-background has-global-padding is-layout-constrained wp-container-core-group-is-layout-0541cdb1 wp-block-group-is-layout-constrained" style={{ borderRadius: "0px", paddingTop: "0", paddingBottom: "0" } as CSSProperties}>
            <div className="wp-block-group alignwide is-content-justification-space-between is-nowrap is-layout-flex wp-container-core-group-is-layout-b82741c8 wp-block-group-is-layout-flex wpbbe-e6d6be20" style={{ paddingTop: "var(--wp--preset--spacing--bbe-160)", paddingBottom: "var(--wp--preset--spacing--bbe-160)" } as CSSProperties}>
              ...
              <div className="wp-block-group is-layout-flow wp-container-core-group-is-layout-2d0a040d wp-block-group-is-layout-flow">
                <p className="has-bbe-neutral-900-color has-text-color has-link-color wp-elements-18 wpbbe-text-style-from-element-h6 wp-block-heading wp-block-paragraph">
                  {`Info`}
                </p>
              ...
              <div className="wp-block-group is-layout-flow wp-container-core-group-is-layout-2d0a040d wp-block-group-is-layout-flow">
                <p className="has-bbe-neutral-900-color has-text-color has-link-color wp-elements-19 wpbbe-text-style-from-element-h6 wp-block-heading wp-block-paragraph">
                  {`Services`}
                </p>
              ...
              <div className="wp-block-group is-vertical is-content-justification-stretch is-layout-flex wp-container-core-group-is-layout-1c934bc6 wp-block-group-is-layout-flex wpbbe-8f3e65ae">
                ...
                <div className="wp-block-group has-border-color has-bbe-neutral-300-border-color has-bbe-neutral-000-background-color has-background is-content-justification-space-between is-nowrap is-layout-flex wp-container-core-group-is-layout-e89909a0 wp-block-group-is-layout-flex" style={{ borderWidth: "1px", borderTopLeftRadius: "3px", borderTopRightRadius: "3px", borderBottomLeftRadius: "3px", borderBottomRightRadius: "3px", paddingTop: "0", paddingRight: "0", paddingBottom: "0", paddingLeft: "0" } as CSSProperties}>
                  <form role="search" method="get" action="https://the7.io/fse-business/" className="wp-block-search__button-outside wp-block-search__icon-button wp-block-search wp-container-content-9cfa9a5a">
                    <label className="wp-block-search__label screen-reader-text" htmlFor="wp-block-search__input-5">
                      {`Search`}
                    </label>
                    <div className="wp-block-search__inside-wrapper" style={{ width: "100%" } as CSSProperties}>
                      <input className="wp-block-search__input has-bbe-small-font-size" id="wp-block-search__input-5" placeholder="Search..." value="" type="search" name="s" required style={{ borderWidth: "0px", borderStyle: "none" } as CSSProperties} />
