  ...
  return (
    <>
      ...
      <div className={"wp-site-blocks"} >
        ...
        <h1 className={"has-text-align-left has-link-color alignwide wp-elements-3 wp-block-post-title has-text-color has-bbe-neutral-000-color has-bbe-display-3-font-size wpbbe-55664e1e"} >About our company</h1>
        </div>
        {" "}
        ...
        {" "}
        <div className={"wp-block-group alignfull has-global-padding is-layout-constrained wp-block-group-is-layout-constrained"} style={{ paddingTop: "var(--wp--preset--spacing--bbe-160)", paddingBottom: "var(--wp--preset--spacing--bbe-160)" } as CSSProperties} >
        {" "}
        <div className={"wp-block-group alignwide is-content-justification-space-between is-nowrap is-layout-flex wp-container-core-group-is-layout-31411b8b wp-block-group-is-layout-flex wpbbe-03f1e384"} >
        {" "}
        ...
        {" "}
        <figure data-aos-easing={"ease-out"} data-aos={"slide-up"} className={"wp-block-image size-full is-style-default wp-container-content-9cfa9a5a wpbbe-541c5741"} >
        <img referrerPolicy={"no-referrer"} fetchPriority={"high"} decoding={"async"} width={"1350"} height={"1800"} src={"https://the7.io/fse-business/wp-content/uploads/sites/133/2026/02/b499.webp"} alt={""} className={"wp-image-19638"} style={{ aspectRatio: "3/4", objectFit: "cover" } as CSSProperties} srcSet={"https://the7.io/fse-business/wp-content/uploads/sites/133/2026/02/b499.webp 1350w, https://the7.io/fse-business/wp-content/uploads/sites/133/2026/02/b499-225x300.webp 225w, https://the7.io/fse-business/wp-content/uploads/sites/133/2026/02/b499-768x1024.webp 768w, https://the7.io/fse-business/wp-content/uploads/sites/133/2026/02/b499-1152x1536.webp 1152w"} sizes={"(max-width: 1350px) 100vw, 1350px"} />
        </figure>
        {" "}
        ...
        {" "}
        <div className={"wp-block-group wp-container-content-0733e5d0 has-global-padding is-content-justification-center is-layout-constrained wp-container-core-group-is-layout-53f598a3 wp-block-group-is-layout-constrained"} style={{ paddingTop: "var(--wp--preset--spacing--0)", paddingRight: "var(--wp--preset--spacing--0)", paddingBottom: "var(--wp--preset--spacing--0)", paddingLeft: "var(--wp--preset--spacing--0)" } as CSSProperties} >
        {" "}
        <h2 className={"wp-block-heading has-text-align-left has-bbe-primary-600-color has-text-color has-link-color wp-elements-4 wpbbe-text-style-from-element-h6"} >Who we are</h2>
        {" "}
        <h3 className={"wp-block-heading wpbbe-text-style-from-element-h1"} >We help businesses make smart financial decisions</h3>
        {" "}
        <div className={"wp-block-group is-layout-flow wp-block-group-is-layout-flow"} >
        {" "}
        <p className={"wp-block-paragraph"} >
        Our company helps businesses handle growth, change, and challenges. We combine experience with practical insight to understand each client’s needs and deliver solutions that make a real difference.
        </p>
        {" "}
        <p className={"wp-block-paragraph"} >
        We focus on clear advice, open communication, and long-term partnerships. Every plan is tailored to your goals and designed to be simple and actionable. We aim for lasting results, helping businesses improve performance, work more efficiently, and move forward with confidence.
        </p>
        {" "}
        </div>
        {" "}
        ...
        {" "}
        <div style={{ "--wp-block-button--hover-text": "var(--wp--preset--color--bbe-primary-800)" } as CSSProperties} className={"wp-block-button is-style-style-6 is-style-style-6--5 has-hover-text"} >
        <a className={"wp-block-button__link has-text-align-center has-bbe-large-font-size has-custom-font-size wp-element-button"} href={"https://the7.io/fse-business/services/"} >Discover our services</a>
        </div>
        {" "}
        </div>
        {" "}
        ...
        {" "}
        <div className={"wp-block-group alignfull has-bbe-neutral-050-background-color has-background has-global-padding is-layout-constrained wp-block-group-is-layout-constrained"} style={{ borderTopLeftRadius: "0px", borderTopRightRadius: "0px", borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px", paddingTop: "var(--wp--preset--spacing--bbe-110)", paddingBottom: "var(--wp--preset--spacing--bbe-110)" } as CSSProperties} >
        {" "}
        <div className={"wp-block-group alignwide is-layout-grid wp-container-core-group-is-layout-60ae31d0 wp-block-group-is-layout-grid"} >
        {" "}
        <div className={"wp-block-group is-layout-grid wp-container-core-group-is-layout-146c3bb4 wp-block-group-is-layout-grid"} >
        {" "}
        <div className={"wp-block-group wp-container-content-8131ecec is-layout-flow wp-container-core-group-is-layout-06d9ed39 wp-block-group-is-layout-flow wpbbe-a0f72751"} style={{ borderTopLeftRadius: "0px", borderTopRightRadius: "0px", borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px", borderLeftColor: "var(--wp--preset--color--bbe-primary-200)", borderLeftWidth: "1px", paddingTop: "0", paddingBottom: "0", paddingLeft: "var(--wp--preset--spacing--bbe-50)" } as CSSProperties} >
        {" "}
        <p className={"has-text-align-left has-bbe-primary-600-color has-text-color has-link-color wp-elements-5 wpbbe-text-style-from-element-h1 wp-block-heading wp-block-paragraph"} style={{ lineHeight: "1" } as CSSProperties} >15+</p>
        {" "}
        <p className={"has-bbe-neutral-900-color has-text-color has-link-color wp-elements-6 wpbbe-text-style-from-element-h6 wp-block-heading wp-block-paragraph"} >Years of experience</p>
        {" "}
        </div>
        {" "}
        <div className={"wp-block-group wp-container-content-8131ecec is-layout-flow wp-container-core-group-is-layout-06d9ed39 wp-block-group-is-layout-flow wpbbe-c4b4e864"} style={{ borderTopLeftRadius: "0px", borderTopRightRadius: "0px", borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px", borderLeftColor: "var(--wp--preset--color--bbe-primary-200)", borderLeftWidth: "1px", paddingTop: "0", paddingBottom: "0", paddingLeft: "var(--wp--preset--spacing--bbe-50)" } as CSSProperties} >
        {" "}
        <p className={"has-text-align-left has-bbe-primary-600-color has-text-color has-link-color wp-elements-7 wpbbe-text-style-from-element-h1 wp-block-heading wp-block-paragraph"} style={{ lineHeight: "1" } as CSSProperties} >450+</p>
        {" "}
        <p className={"has-bbe-neutral-900-color has-text-color has-link-color wp-elements-8 wpbbe-text-style-from-element-h6 wp-block-heading wp-block-paragraph"} >Successful cases</p>
        {" "}
        </div>
        {" "}
        </div>
        ...
        <div className={"wp-block-group is-layout-grid wp-container-core-group-is-layout-146c3bb4 wp-block-group-is-layout-grid"} >
        {" "}
        <div className={"wp-block-group wp-container-content-8131ecec is-layout-flow wp-container-core-group-is-layout-06d9ed39 wp-block-group-is-layout-flow wpbbe-fc15e3d6"} style={{ borderTopLeftRadius: "0px", borderTopRightRadius: "0px", borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px", borderLeftColor: "var(--wp--preset--color--bbe-primary-200)", borderLeftWidth: "1px", paddingTop: "0", paddingBottom: "0", paddingLeft: "var(--wp--preset--spacing--bbe-50)" } as CSSProperties} >
        {" "}
        <p className={"has-text-align-left has-bbe-primary-600-color has-text-color has-link-color wp-elements-9 wpbbe-text-style-from-element-h1 wp-block-heading wp-block-paragraph"} style={{ lineHeight: "1" } as CSSProperties} >750K</p>
        {" "}
        <p className={"has-bbe-neutral-900-color has-text-color has-link-color wp-elements-10 wpbbe-text-style-from-element-h6 wp-block-heading wp-block-paragraph"} >Clients worldwide</p>
        {" "}
        </div>
        {" "}
        <div className={"wp-block-group wp-container-content-8131ecec is-layout-flow wp-container-core-group-is-layout-06d9ed39 wp-block-group-is-layout-flow wpbbe-081cf98c"} style={{ borderTopLeftRadius: "0px", borderTopRightRadius: "0px", borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px", borderLeftColor: "var(--wp--preset--color--bbe-primary-200)", borderLeftWidth: "1px", paddingTop: "0", paddingBottom: "0", paddingLeft: "var(--wp--preset--spacing--bbe-50)" } as CSSProperties} >
        {" "}
        <p className={"has-text-align-left has-bbe-primary-600-color has-text-color has-link-color wp-elements-11 wpbbe-text-style-from-element-h1 wp-block-heading wp-block-paragraph"} style={{ lineHeight: "1" } as CSSProperties} >98.5%</p>
        {" "}
        <p className={"has-bbe-neutral-900-color has-text-color has-link-color wp-elements-12 wpbbe-text-style-from-element-h6 wp-block-heading wp-block-paragraph"} >Customers satisfaction</p>
        {" "}
        </div>
        {" "}
        </div>
        ...
        {" "}
        <div className={"wp-block-group alignfull has-bbe-neutral-000-background-color has-background has-global-padding is-layout-constrained wp-block-group-is-layout-constrained"} style={{ paddingTop: "var(--wp--preset--spacing--bbe-160)", paddingBottom: "var(--wp--preset--spacing--bbe-160)" } as CSSProperties} >
        {" "}
        <div className={"wp-block-group alignwide is-horizontal is-content-justification-space-between is-nowrap is-layout-flex wp-container-core-group-is-layout-a83ba19e wp-block-group-is-layout-flex wpbbe-ba4b6260"} >
        {" "}
        <div className={"wp-block-group wp-container-content-0733e5d0 has-global-padding is-content-justification-center is-layout-constrained wp-container-core-group-is-layout-0fdfd390 wp-block-group-is-layout-constrained"} >
        {" "}
        <h2 className={"wp-block-heading has-text-align-left has-bbe-primary-600-color has-text-color has-link-color wp-elements-13 wpbbe-text-style-from-element-h6"} >Core values & principles</h2>
        {" "}
        <h3 className={"wp-block-heading wpbbe-text-style-from-element-h1"} >Our business philosophy</h3>
        {" "}
        <p className={"wp-block-paragraph"} >
        Our work is guided by clear principles that shape how we think, act, and partner with our clients. These values define our approach, inspire our decisions, and ensure we consistently deliver meaningful, lasting results.
        </p>
        {" "}
        </div>
        {" "}
        <div className={"wp-block-group wp-container-content-0733e5d0 has-global-padding is-layout-constrained wp-container-core-group-is-layout-ff26d1fd wp-block-group-is-layout-constrained"} >
        {" "}
        <div className={"wp-block-group is-layout-flow wp-container-core-group-is-layout-040bf5fe wp-block-group-is-layout-flow"} >
        {" "}
        <div className={"wp-block-group is-content-justification-space-between is-nowrap is-layout-flex wp-container-core-group-is-layout-8c63b1d6 wp-block-group-is-layout-flex wpbbe-23f5a324"} style={{ borderTopLeftRadius: "0px", borderTopRightRadius: "0px", borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px", borderLeftColor: "var(--wp--preset--color--bbe-primary-200)", borderLeftWidth: "1px", minHeight: "0px", paddingTop: "0", paddingRight: "0", paddingBottom: "0", paddingLeft: "var(--wp--preset--spacing--bbe-70)" } as CSSProperties} >
        {" "}
        <p className={"has-text-align-center has-bbe-primary-600-color has-text-color has-link-color wp-elements-14 wp-container-content-4dd21e30 wpbbe-flex-item-prevent-shrinking wpbbe-4e25305c wpbbe-text-style-from-element-h2 wp-block-heading wp-block-paragraph"} style={{ lineHeight: "1" } as CSSProperties} >1.</p>
        {" "}
        ...
        {" "}
        <h3 className={"wp-block-heading wpbbe-text-style-from-element-h4"} >Financial transparency</h3>
        {" "}
        <p className={"wp-container-content-9cfa9a5a wp-block-paragraph"} >Every report is presented openly, enabling clients to make informed decisions.</p>
        {" "}
        </div>
        {" "}
        </div>
        {" "}
        <div className={"wp-block-group is-content-justification-space-between is-nowrap is-layout-flex wp-container-core-group-is-layout-8c63b1d6 wp-block-group-is-layout-flex wpbbe-c145b524"} style={{ borderTopLeftRadius: "0px", borderTopRightRadius: "0px", borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px", borderLeftColor: "var(--wp--preset--color--bbe-primary-200)", borderLeftWidth: "1px", minHeight: "0px", paddingTop: "0", paddingRight: "0", paddingBottom: "0", paddingLeft: "var(--wp--preset--spacing--bbe-70)" } as CSSProperties} >
        {" "}
        <p className={"has-text-align-center has-bbe-primary-600-color has-text-color has-link-color wp-elements-15 wp-container-content-4dd21e30 wpbbe-flex-item-prevent-shrinking wpbbe-6eac7fb8 wpbbe-text-style-from-element-h2 wp-block-heading wp-block-paragraph"} style={{ lineHeight: "1" } as CSSProperties} >2.</p>
        {" "}
        <div className={"wp-block-group wp-container-content-9cfa9a5a is-layout-flow wp-container-core-group-is-layout-add8a69b wp-block-group-is-layout-flow"} >
        {" "}
        <h3 className={"wp-block-heading wpbbe-text-style-from-element-h4"} >Excellence in client care</h3>
        {" "}
        <p className={"wp-container-content-9cfa9a5a wp-block-paragraph"} >We put clients first, building trust and partnerships through understanding, responsiveness, and thoughtful guidance.</p>
        {" "}
        </div>
        {" "}
        </div>
        {" "}
        <div className={"wp-block-group is-content-justification-space-between is-nowrap is-layout-flex wp-container-core-group-is-layout-8c63b1d6 wp-block-group-is-layout-flex wpbbe-aedf2e9f"} style={{ borderTopLeftRadius: "0px", borderTopRightRadius: "0px", borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px", borderLeftColor: "var(--wp--preset--color--bbe-primary-200)", borderLeftWidth: "1px", minHeight: "0px", paddingTop: "0", paddingRight: "0", paddingBottom: "0", paddingLeft: "var(--wp--preset--spacing--bbe-70)" } as CSSProperties} >
        {" "}
        <p className={"has-text-align-center has-bbe-primary-600-color has-text-color has-link-color wp-elements-16 wp-container-content-4dd21e30 wpbbe-flex-item-prevent-shrinking wpbbe-4fb824b6 wpbbe-text-style-from-element-h2 wp-block-heading wp-block-paragraph"} style={{ lineHeight: "1" } as CSSProperties} >3.</p>
        {" "}
        <div className={"wp-block-group wp-container-content-9cfa9a5a is-layout-flow wp-container-core-group-is-layout-add8a69b wp-block-group-is-layout-flow"} >
        {" "}
        <h3 className={"wp-block-heading wpbbe-text-style-from-element-h4"} >Precision & reliability</h3>
        {" "}
        <p className={"wp-container-content-9cfa9a5a wp-block-paragraph"} >Every solution we provide is carefully crafted to ensure accuracy, practical impact, and lasting value.</p>
        {" "}
        </div>
        {" "}
        </div>
        ...
        {" "}
        <div className={"wp-block-group alignfull has-bbe-neutral-300-color has-bbe-primary-950-background-color has-text-color has-background has-link-color wp-elements-17 has-global-padding is-layout-constrained wp-container-core-group-is-layout-73544852 wp-block-group-is-layout-constrained"} style={{ borderRadius: "0px", paddingTop: "var(--wp--preset--spacing--bbe-160)", paddingBottom: "var(--wp--preset--spacing--bbe-160)", backgroundImage: "url('https://the7.io/fse-business/wp-content/uploads/sites/133/2026/05/art-site-t-r.svg')", backgroundPosition: "100% 0%", backgroundRepeat: "no-repeat", backgroundSize: "100%" } as CSSProperties} >
        {" "}
        <div className={"wp-block-group alignwide is-horizontal is-content-justification-space-between is-nowrap is-layout-flex wp-container-core-group-is-layout-a83ba19e wp-block-group-is-layout-flex wpbbe-3db58684"} >
        {" "}
        <div className={"wp-block-group wp-container-content-0733e5d0 has-global-padding is-layout-constrained wp-container-core-group-is-layout-0603880f wp-block-group-is-layout-constrained"} style={{ paddingTop: "var(--wp--preset--spacing--0)", paddingRight: "var(--wp--preset--spacing--0)", paddingBottom: "var(--wp--preset--spacing--0)", paddingLeft: "var(--wp--preset--spacing--0)" } as CSSProperties} >
        {" "}
        ...
        {" "}
        <div className={"wp-block-group wp-container-content-0733e5d0 has-global-padding is-layout-constrained wp-container-core-group-is-layout-d6293ceb wp-block-group-is-layout-constrained"} style={{ paddingTop: "var(--wp--preset--spacing--0)", paddingRight: "var(--wp--preset--spacing--0)", paddingBottom: "var(--wp--preset--spacing--0)", paddingLeft: "var(--wp--preset--spacing--0)" } as CSSProperties} >
        {" "}
        <div className={"wp-block-group is-layout-flow wp-container-core-group-is-layout-2d0a040d wp-block-group-is-layout-flow"} >
        {" "}
        <h2 className={"wp-block-heading has-text-align-left has-bbe-primary-400-color has-text-color has-link-color wp-elements-18 wpbbe-text-style-from-element-h6"} >Why work with us</h2>
        {" "}
        <h3 className={"wp-block-heading wpbbe-text-style-from-element-h1"} >Partner with us for practical, reliable results</h3>
        {" "}
        </div>
        {" "}
        <div className={"wp-block-group has-bbe-neutral-000-color has-text-color has-link-color has-bbe-x-large-font-size wp-elements-19 is-layout-flow wp-container-core-group-is-layout-cdec974d wp-block-group-is-layout-flow"} style={{ fontStyle: "normal", fontWeight: "400", lineHeight: "1.4" } as CSSProperties} >
        {" "}
        <div className={"wp-block-group is-content-justification-space-between is-nowrap is-layout-flex wp-container-core-group-is-layout-9a09f718 wp-block-group-is-layout-flex"} >
        <div className={"wpbbe-svg-icon wpbbe-5d3345ad wp-block-wpbbe-svg-inline wpbbe-flex-item-prevent-shrinking"} >
        ...
        {" "}
        <p className={"wp-container-content-9cfa9a5a wp-block-paragraph"} >Decisions based on careful analysis</p>
        {" "}
        </div>
        {" "}
        <div className={"wp-block-group is-content-justification-space-between is-nowrap is-layout-flex wp-container-core-group-is-layout-9a09f718 wp-block-group-is-layout-flex"} >
        ...
        {" "}
        <p className={"wp-container-content-9cfa9a5a wp-block-paragraph"} >We focus on your goals</p>
        {" "}
        </div>
        {" "}
        <div className={"wp-block-group is-content-justification-space-between is-nowrap is-layout-flex wp-container-core-group-is-layout-9a09f718 wp-block-group-is-layout-flex"} >
        ...
        {" "}
        <p className={"wp-container-content-9cfa9a5a wp-block-paragraph"} >Clear reporting and open communication</p>
        {" "}
        </div>
        {" "}
        <div className={"wp-block-group is-content-justification-space-between is-nowrap is-layout-flex wp-container-core-group-is-layout-9a09f718 wp-block-group-is-layout-flex"} >
        ...
        {" "}
        <p className={"wp-container-content-9cfa9a5a wp-block-paragraph"} >Solutions tailored to your needs</p>
        {" "}
        </div>
        {" "}
        <div className={"wp-block-group is-content-justification-space-between is-nowrap is-layout-flex wp-container-core-group-is-layout-9a09f718 wp-block-group-is-layout-flex"} >
        ...
        {" "}
        <p className={"wp-container-content-9cfa9a5a wp-block-paragraph"} >Experienced professionals across industries</p>
        {" "}
        </div>
        {" "}
        </div>
        {" "}
        <div className={"wp-block-buttons is-layout-flex wp-block-buttons-is-layout-flex"} style={{ marginTop: "var(--wp--preset--spacing--bbe-100)" } as CSSProperties} >
        {" "}
        <div style={{ "--wp-block-button--hover-background": "var(--wp--preset--color--bbe-primary-700)" } as CSSProperties} className={"wp-block-button is-style-style-4 is-style-style-4--6 has-hover-background"} >
        <a className={"wp-block-button__link has-text-align-center wp-element-button"} href={"/login"} >Login</a>
        </div>
        {" "}
        </div>
        {" "}
        ...
        {" "}
        <div className={"wp-block-group alignfull has-bbe-neutral-050-background-color has-background has-global-padding is-layout-constrained wp-container-core-group-is-layout-ec1a6167 wp-block-group-is-layout-constrained"} style={{ paddingTop: "var(--wp--preset--spacing--bbe-160)", paddingBottom: "var(--wp--preset--spacing--bbe-160)" } as CSSProperties} >
        {" "}
        <div className={"wp-block-group alignwide has-global-padding is-layout-constrained wp-container-core-group-is-layout-8f854688 wp-block-group-is-layout-constrained"} style={{ paddingTop: "var(--wp--preset--spacing--0)", paddingRight: "var(--wp--preset--spacing--0)", paddingBottom: "var(--wp--preset--spacing--0)", paddingLeft: "var(--wp--preset--spacing--0)" } as CSSProperties} >
        {" "}
        <h2 className={"wp-block-heading has-text-align-center has-bbe-primary-600-color has-text-color has-link-color wp-elements-20 wpbbe-text-style-from-element-h6"} >Get to know us</h2>
        {" "}
        <h3 className={"wp-block-heading has-text-align-center wpbbe-text-style-from-element-h1"} >Your team of dedicated experts</h3>
        {" "}
        <p className={"has-text-align-center wp-block-paragraph"} >
        Our team brings expertise and practical experience to help businesses achieve their goals. We provide guidance, insight, and tailored solutions that make a real impact.
        </p>
        {" "}
        </div>
        {" "}
        <div className={"wp-block-wpbbe-simple-scroller alignwide wpbbe-simple-scroller nativeScroll wpbbe-12eaa5e1 nsNotReady"} >
        {" "}
        <div className={"wp-block-group is-content-justification-space-between is-nowrap is-layout-flex wp-container-core-group-is-layout-600e216f wp-block-group-is-layout-flex"} >
        <div className={"wpbbe-svg-icon wpbbe-3b6805cf nsArrow nsLeftArrow wp-block-wpbbe-simple-scroller-arrow-left wpbbe-flex-item-prevent-shrinking"} >
        ...
        <img referrerPolicy={"no-referrer"} loading={"lazy"} decoding={"async"} width={"1000"} height={"1000"} src={"https://the7.io/fse-business/wp-content/uploads/sites/133/2024/09/t-img011.jpg"} alt={""} className={"wp-image-1099"} style={{ aspectRatio: "1", objectFit: "cover" } as CSSProperties} srcSet={"https://the7.io/fse-business/wp-content/uploads/sites/133/2024/09/t-img011.jpg 1000w, https://the7.io/fse-business/wp-content/uploads/sites/133/2024/09/t-img011-300x300.jpg 300w, https://the7.io/fse-business/wp-content/uploads/sites/133/2024/09/t-img011-150x150.jpg 150w, https://the7.io/fse-business/wp-content/uploads/sites/133/2024/09/t-img011-768x768.jpg 768w"} sizes={"(max-width: 1000px) 100vw, 1000px"} />
        </figure>
        {" "}
        <div className={"wp-block-group is-layout-flow wp-container-core-group-is-layout-a1ed1134 wp-block-group-is-layout-flow"} >
        {" "}
        <p className={"has-text-align-left has-bbe-neutral-900-color has-text-color has-link-color wp-elements-21 wpbbe-text-style-from-element-h6 wp-block-heading wp-block-paragraph"} style={{ fontStyle: "normal", fontWeight: "500", lineHeight: "1.4" } as CSSProperties} >Miriam Lee</p>
        {" "}
        <p className={"has-text-align-left has-bbe-neutral-500-color has-text-color has-link-color has-bbe-x-small-font-size wp-elements-22 wp-block-paragraph"} style={{ fontStyle: "normal", fontWeight: "400", lineHeight: "1.3" } as CSSProperties} >Senior Business Consultant</p>
        {" "}
        </div>
        {" "}
        </div>
        ...
        {" "}
        <figure className={"wp-block-image size-full is-style-default"} >
        <img referrerPolicy={"no-referrer"} loading={"lazy"} decoding={"async"} width={"1000"} height={"1000"} src={"https://the7.io/fse-business/wp-content/uploads/sites/133/2024/09/t-img009.jpg"} alt={""} className={"wp-image-1097"} style={{ aspectRatio: "1", objectFit: "cover" } as CSSProperties} srcSet={"https://the7.io/fse-business/wp-content/uploads/sites/133/2024/09/t-img009.jpg 1000w, https://the7.io/fse-business/wp-content/uploads/sites/133/2024/09/t-img009-300x300.jpg 300w, https://the7.io/fse-business/wp-content/uploads/sites/133/2024/09/t-img009-150x150.jpg 150w, https://the7.io/fse-business/wp-content/uploads/sites/133/2024/09/t-img009-768x768.jpg 768w"} sizes={"(max-width: 1000px) 100vw, 1000px"} />
        </figure>
        {" "}
        <div className={"wp-block-group is-layout-flow wp-container-core-group-is-layout-a1ed1134 wp-block-group-is-layout-flow"} >
        {" "}
        <p className={"has-text-align-left has-bbe-neutral-900-color has-text-color has-link-color wp-elements-23 wpbbe-text-style-from-element-h6 wp-block-heading wp-block-paragraph"} style={{ fontStyle: "normal", fontWeight: "500", lineHeight: "1.4" } as CSSProperties} >Alexander Cole</p>
        {" "}
        <p className={"has-text-align-left has-bbe-neutral-500-color has-text-color has-link-color has-bbe-x-small-font-size wp-elements-24 wp-block-paragraph"} style={{ fontStyle: "normal", fontWeight: "400", lineHeight: "1.3" } as CSSProperties} >Managing Director</p>
        {" "}
        </div>
        {" "}
        </div>
        ...
        {" "}
        <figure className={"wp-block-image size-full is-style-default"} >
        <img referrerPolicy={"no-referrer"} loading={"lazy"} decoding={"async"} width={"1000"} height={"1000"} src={"https://the7.io/fse-business/wp-content/uploads/sites/133/2024/09/t-img018.jpg"} alt={""} className={"wp-image-1105"} style={{ aspectRatio: "1", objectFit: "cover" } as CSSProperties} srcSet={"https://the7.io/fse-business/wp-content/uploads/sites/133/2024/09/t-img018.jpg 1000w, https://the7.io/fse-business/wp-content/uploads/sites/133/2024/09/t-img018-300x300.jpg 300w, https://the7.io/fse-business/wp-content/uploads/sites/133/2024/09/t-img018-150x150.jpg 150w, https://the7.io/fse-business/wp-content/uploads/sites/133/2024/09/t-img018-768x768.jpg 768w"} sizes={"(max-width: 1000px) 100vw, 1000px"} />
        </figure>
        {" "}
        <div className={"wp-block-group is-layout-flow wp-container-core-group-is-layout-a1ed1134 wp-block-group-is-layout-flow"} >
        {" "}
        <p className={"has-text-align-left has-bbe-neutral-900-color has-text-color has-link-color wp-elements-25 wpbbe-text-style-from-element-h6 wp-block-heading wp-block-paragraph"} style={{ fontStyle: "normal", fontWeight: "500", lineHeight: "1.4" } as CSSProperties} >Sophia Turner</p>
        {" "}
        <p className={"has-text-align-left has-bbe-neutral-500-color has-text-color has-link-color has-bbe-x-small-font-size wp-elements-26 wp-block-paragraph"} style={{ fontStyle: "normal", fontWeight: "400", lineHeight: "1.3" } as CSSProperties} >Financial Strategy Lead</p>
        {" "}
        </div>
        {" "}
        </div>
        ...
        <div className={"wp-block-group is-layout-flow wp-container-core-group-is-layout-a1ed1134 wp-block-group-is-layout-flow"} >
        {" "}
        <p className={"has-text-align-left has-bbe-neutral-900-color has-text-color has-link-color wp-elements-27 wpbbe-text-style-from-element-h6 wp-block-heading wp-block-paragraph"} style={{ fontStyle: "normal", fontWeight: "500", lineHeight: "1.4" } as CSSProperties} >Olivia Bennett</p>
        {" "}
        <p className={"has-text-align-left has-bbe-neutral-500-color has-text-color has-link-color has-bbe-x-small-font-size wp-elements-28 wp-block-paragraph"} style={{ fontStyle: "normal", fontWeight: "400", lineHeight: "1.3" } as CSSProperties} >Data and Analytics Consultant</p>
        {" "}
        </div>
        {" "}
        </div>
        ...
        {" "}
        <figure className={"wp-block-image size-full is-style-default"} >
        <img referrerPolicy={"no-referrer"} loading={"lazy"} decoding={"async"} width={"1000"} height={"1000"} src={"https://the7.io/fse-business/wp-content/uploads/sites/133/2024/09/t-img003.jpg"} alt={""} className={"wp-image-1089"} style={{ aspectRatio: "1", objectFit: "cover" } as CSSProperties} srcSet={"https://the7.io/fse-business/wp-content/uploads/sites/133/2024/09/t-img003.jpg 1000w, https://the7.io/fse-business/wp-content/uploads/sites/133/2024/09/t-img003-300x300.jpg 300w, https://the7.io/fse-business/wp-content/uploads/sites/133/2024/09/t-img003-150x150.jpg 150w, https://the7.io/fse-business/wp-content/uploads/sites/133/2024/09/t-img003-768x768.jpg 768w"} sizes={"(max-width: 1000px) 100vw, 1000px"} />
        </figure>
        {" "}
        <div className={"wp-block-group is-layout-flow wp-container-core-group-is-layout-a1ed1134 wp-block-group-is-layout-flow"} >
        {" "}
        <p className={"has-text-align-left has-bbe-neutral-900-color has-text-color has-link-color wp-elements-29 wpbbe-text-style-from-element-h6 wp-block-heading wp-block-paragraph"} style={{ fontStyle: "normal", fontWeight: "500", lineHeight: "1.4" } as CSSProperties} >Tiffany Green</p>
        {" "}
        <p className={"has-text-align-left has-bbe-neutral-500-color has-text-color has-link-color has-bbe-x-small-font-size wp-elements-30 wp-block-paragraph"} style={{ fontStyle: "normal", fontWeight: "400", lineHeight: "1.3" } as CSSProperties} >Senior Business Consultant</p>
        {" "}
        </div>
        {" "}
        </div>
        ...
        {" "}
        <figure className={"wp-block-image size-full is-style-default"} >
        <img referrerPolicy={"no-referrer"} loading={"lazy"} decoding={"async"} width={"1000"} height={"1000"} src={"https://the7.io/fse-business/wp-content/uploads/sites/133/2024/09/t-img001.jpg"} alt={""} className={"wp-image-1091"} style={{ aspectRatio: "1", objectFit: "cover" } as CSSProperties} srcSet={"https://the7.io/fse-business/wp-content/uploads/sites/133/2024/09/t-img001.jpg 1000w, https://the7.io/fse-business/wp-content/uploads/sites/133/2024/09/t-img001-300x300.jpg 300w, https://the7.io/fse-business/wp-content/uploads/sites/133/2024/09/t-img001-150x150.jpg 150w, https://the7.io/fse-business/wp-content/uploads/sites/133/2024/09/t-img001-768x768.jpg 768w"} sizes={"(max-width: 1000px) 100vw, 1000px"} />
        </figure>
        {" "}
        <div className={"wp-block-group is-layout-flow wp-container-core-group-is-layout-a1ed1134 wp-block-group-is-layout-flow"} >
        {" "}
        <p className={"has-text-align-left has-bbe-neutral-900-color has-text-color has-link-color wp-elements-31 wpbbe-text-style-from-element-h6 wp-block-heading wp-block-paragraph"} style={{ fontStyle: "normal", fontWeight: "500", lineHeight: "1.4" } as CSSProperties} >Isabella Reed</p>
        {" "}
        <p className={"has-text-align-left has-bbe-neutral-500-color has-text-color has-link-color has-bbe-x-small-font-size wp-elements-32 wp-block-paragraph"} style={{ fontStyle: "normal", fontWeight: "400", lineHeight: "1.3" } as CSSProperties} >Client Support Manager</p>
        {" "}
        </div>
        {" "}
        </div>
        ...
        {" "}
        <div className={"wpbbe-svg-icon wpbbe-f0023670 nsArrow nsRightArrow wp-block-wpbbe-simple-scroller-arrow-right wpbbe-flex-item-prevent-shrinking"} >
        ...
        {" "}
        <div className={"nsProgressTrackWrapper wpbbe-61e8190f wp-block-wpbbe-simple-scroller-indicator wp-container-content-9cfa9a5a"} >
        {" "}
        ...
        {" "}
        <div className={"wp-block-group alignfull has-bbe-neutral-000-background-color has-background has-global-padding is-layout-constrained wp-container-core-group-is-layout-ec1a6167 wp-block-group-is-layout-constrained"} style={{ paddingTop: "var(--wp--preset--spacing--bbe-160)", paddingBottom: "var(--wp--preset--spacing--bbe-160)" } as CSSProperties} >
        {" "}
        <div className={"wp-block-group alignwide has-global-padding is-layout-constrained wp-container-core-group-is-layout-616e06f3 wp-block-group-is-layout-constrained"} style={{ marginBottom: "var(--wp--preset--spacing--bbe-60)", paddingTop: "var(--wp--preset--spacing--0)", paddingRight: "var(--wp--preset--spacing--0)", paddingBottom: "var(--wp--preset--spacing--0)", paddingLeft: "var(--wp--preset--spacing--0)" } as CSSProperties} >
        {" "}
        <h2 className={"wp-block-heading has-text-align-center has-bbe-primary-600-color has-text-color has-link-color wp-elements-33 wpbbe-text-style-from-element-h6"} >Milestones</h2>
        {" "}
        <h3 className={"wp-block-heading has-text-align-center wpbbe-text-style-from-element-h1"} >Discover our history</h3>
        {" "}
        </div>
        {" "}
        <div className={"wp-block-group alignwide is-layout-flow wp-container-core-group-is-layout-fdf86fc4 wp-block-group-is-layout-flow"} >
        {" "}
        <div className={"wp-block-group is-horizontal is-content-justification-space-between is-nowrap is-layout-flex wp-container-core-group-is-layout-c2c1c3f2 wp-block-group-is-layout-flex wpbbe-01f207dd"} >
        {" "}
        <div className={"wp-block-group wp-container-content-b04ba3db is-vertical is-content-justification-stretch is-layout-flex wp-container-core-group-is-layout-5b8ab76f wp-block-group-is-layout-flex wpbbe-flex-item-prevent-shrinking"} style={{ borderTopLeftRadius: "0px", borderTopRightRadius: "0px", borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px", borderRightColor: "var(--wp--preset--color--bbe-primary-200)", borderRightWidth: "1px", marginTop: "0", marginBottom: "0", paddingTop: "0", paddingRight: "0", paddingBottom: "0", paddingLeft: "0" } as CSSProperties} >
        {" "}
        <div className={"wp-block-group is-nowrap is-layout-flex wp-container-core-group-is-layout-b72bb12e wp-block-group-is-layout-flex"} >
        {" "}
        <p data-aos-easing={"ease-out"} data-aos={"slide-up"} className={"has-text-align-left has-bbe-primary-600-color has-text-color has-link-color wp-elements-34 wpbbe-c0c673bd wpbbe-text-style-from-element-h1 wp-block-heading wp-block-paragraph"} style={{ marginTop: "0", marginRight: "0", marginLeft: "0", paddingTop: "0", lineHeight: "1" } as CSSProperties} >2012</p>
        {" "}
        <hr className={"wp-block-separator has-text-color has-bbe-primary-200-color has-alpha-channel-opacity has-bbe-primary-200-background-color has-background is-style-wide wp-container-content-9cfa9a5a"} />
        {" "}
        </div>
        {" "}
        </div>
        {" "}
        <div className={"wp-block-group is-content-justification-space-between is-nowrap is-layout-flex wp-container-core-group-is-layout-1a8b5569 wp-block-group-is-layout-flex wpbbe-0f492775"} style={{ marginTop: "0", marginBottom: "0", paddingTop: "0", paddingBottom: "var(--wp--preset--spacing--bbe-130)" } as CSSProperties} >
        {" "}
        <div data-aos-easing={"ease-out"} data-aos={"fade-in"} className={"wp-block-group wp-container-content-b99e70a5 has-global-padding is-content-justification-center is-layout-constrained wp-container-core-group-is-layout-17672e18 wp-block-group-is-layout-constrained wpbbe-acdb8c3e wpbbe-flex-item-prevent-shrinking"} >
        {" "}
        <h3 className={"wp-block-heading"} >Our first steps</h3>
        {" "}
        <div className={"wp-block-group is-layout-flow wp-block-group-is-layout-flow"} >
        {" "}
        <p className={"wp-block-paragraph"} >
        ...
        {" "}
        <figure data-aos-easing={"ease-out"} data-aos={"slide-up"} className={"wp-block-image size-large is-style-default wp-container-content-9cfa9a5a wpbbe-dcd807fe"} >
        <img referrerPolicy={"no-referrer"} loading={"lazy"} decoding={"async"} width={"1024"} height={"683"} src={"https://the7.io/fse-business/wp-content/uploads/sites/133/2026/02/b119-1024x683.webp"} alt={""} className={"wp-image-19706"} style={{ aspectRatio: "16/9", objectFit: "cover" } as CSSProperties} srcSet={"https://the7.io/fse-business/wp-content/uploads/sites/133/2026/02/b119-1024x683.webp 1024w, https://the7.io/fse-business/wp-content/uploads/sites/133/2026/02/b119-300x200.webp 300w, https://the7.io/fse-business/wp-content/uploads/sites/133/2026/02/b119-768x512.webp 768w, https://the7.io/fse-business/wp-content/uploads/sites/133/2026/02/b119-1536x1024.webp 1536w, https://the7.io/fse-business/wp-content/uploads/sites/133/2026/02/b119.webp 1800w"} sizes={"(max-width: 1024px) 100vw, 1024px"} />
        </figure>
        {" "}
        </div>
        {" "}
        ...
        {" "}
        <div className={"wp-block-group is-horizontal is-content-justification-space-between is-nowrap is-layout-flex wp-container-core-group-is-layout-c2c1c3f2 wp-block-group-is-layout-flex wpbbe-0919bc5b"} >
        {" "}
        <div className={"wp-block-group wp-container-content-b04ba3db is-vertical is-content-justification-stretch is-layout-flex wp-container-core-group-is-layout-5b8ab76f wp-block-group-is-layout-flex wpbbe-flex-item-prevent-shrinking"} style={{ borderTopLeftRadius: "0px", borderTopRightRadius: "0px", borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px", borderRightColor: "var(--wp--preset--color--bbe-primary-200)", borderRightWidth: "1px", marginTop: "0", marginBottom: "0", paddingTop: "0", paddingRight: "0", paddingBottom: "0", paddingLeft: "0" } as CSSProperties} >
        {" "}
        <div className={"wp-block-group is-nowrap is-layout-flex wp-container-core-group-is-layout-b72bb12e wp-block-group-is-layout-flex"} >
        {" "}
        <p data-aos-easing={"ease-out"} data-aos={"slide-up"} className={"has-text-align-left has-bbe-primary-600-color has-text-color has-link-color wp-elements-35 wpbbe-893eea9f wpbbe-text-style-from-element-h1 wp-block-heading wp-block-paragraph"} style={{ marginTop: "0", marginRight: "0", marginLeft: "0", paddingTop: "0", lineHeight: "1" } as CSSProperties} >2017</p>
        {" "}
        <hr className={"wp-block-separator has-text-color has-bbe-primary-200-color has-alpha-channel-opacity has-bbe-primary-200-background-color has-background is-style-wide wp-container-content-9cfa9a5a"} />
        {" "}
        </div>
        ...
        {" "}
        <div className={"wp-block-group is-content-justification-space-between is-nowrap is-layout-flex wp-container-core-group-is-layout-1a8b5569 wp-block-group-is-layout-flex wpbbe-938a38b7"} style={{ marginTop: "0", marginBottom: "0", paddingTop: "0", paddingBottom: "var(--wp--preset--spacing--bbe-130)" } as CSSProperties} >
        {" "}
        <div data-aos-easing={"ease-out"} data-aos={"fade-in"} className={"wp-block-group wp-container-content-b99e70a5 has-global-padding is-layout-constrained wp-container-core-group-is-layout-b818fde2 wp-block-group-is-layout-constrained wpbbe-2b39e649 wpbbe-flex-item-prevent-shrinking"} >
        {" "}
        <h3 className={"wp-block-heading"} >Recognized for excellence</h3>
        {" "}
        <div className={"wp-block-group is-layout-flow wp-block-group-is-layout-flow"} >
        {" "}
        <p className={"wp-block-paragraph"} >
        ...
        {" "}
        <figure data-aos-easing={"ease-out"} data-aos={"slide-up"} className={"wp-block-image size-large is-style-default wp-container-content-9cfa9a5a wpbbe-3fad5804"} >
        <img referrerPolicy={"no-referrer"} loading={"lazy"} decoding={"async"} width={"1024"} height={"683"} src={"https://the7.io/fse-business/wp-content/uploads/sites/133/2026/02/b778-1024x683.webp"} alt={""} className={"wp-image-19703"} style={{ aspectRatio: "16/9", objectFit: "cover" } as CSSProperties} srcSet={"https://the7.io/fse-business/wp-content/uploads/sites/133/2026/02/b778-1024x683.webp 1024w, https://the7.io/fse-business/wp-content/uploads/sites/133/2026/02/b778-300x200.webp 300w, https://the7.io/fse-business/wp-content/uploads/sites/133/2026/02/b778-768x512.webp 768w, https://the7.io/fse-business/wp-content/uploads/sites/133/2026/02/b778-1536x1024.webp 1536w, https://the7.io/fse-business/wp-content/uploads/sites/133/2026/02/b778.webp 1800w"} sizes={"(max-width: 1024px) 100vw, 1024px"} />
        </figure>
        {" "}
        </div>
        {" "}
        ...
        {" "}
        <div className={"wp-block-group is-horizontal is-content-justification-space-between is-nowrap is-layout-flex wp-container-core-group-is-layout-c2c1c3f2 wp-block-group-is-layout-flex wpbbe-afda2857"} >
        {" "}
        <div className={"wp-block-group wp-container-content-b04ba3db is-vertical is-content-justification-stretch is-layout-flex wp-container-core-group-is-layout-5b8ab76f wp-block-group-is-layout-flex wpbbe-flex-item-prevent-shrinking"} style={{ borderTopLeftRadius: "0px", borderTopRightRadius: "0px", borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px", borderRightColor: "var(--wp--preset--color--bbe-primary-200)", borderRightWidth: "1px", marginTop: "0", marginBottom: "0", paddingTop: "0", paddingRight: "0", paddingBottom: "0", paddingLeft: "0" } as CSSProperties} >
        {" "}
        <div className={"wp-block-group is-nowrap is-layout-flex wp-container-core-group-is-layout-b72bb12e wp-block-group-is-layout-flex"} >
        {" "}
        <p data-aos-easing={"ease-out"} data-aos={"slide-up"} className={"has-text-align-left has-bbe-primary-600-color has-text-color has-link-color wp-elements-36 wpbbe-a312b4c3 wpbbe-text-style-from-element-h1 wp-block-heading wp-block-paragraph"} style={{ marginTop: "0", marginRight: "0", marginLeft: "0", paddingTop: "0", lineHeight: "1" } as CSSProperties} >2022</p>
        {" "}
        <hr className={"wp-block-separator has-text-color has-bbe-primary-200-color has-alpha-channel-opacity has-bbe-primary-200-background-color has-background is-style-wide wp-container-content-9cfa9a5a"} />
        {" "}
        </div>
        ...
        {" "}
        <div className={"wp-block-group is-content-justification-space-between is-nowrap is-layout-flex wp-container-core-group-is-layout-1a8b5569 wp-block-group-is-layout-flex wpbbe-d5aa9bc0"} style={{ marginTop: "0", marginBottom: "0", paddingTop: "0", paddingBottom: "var(--wp--preset--spacing--bbe-130)" } as CSSProperties} >
        {" "}
        <div data-aos-easing={"ease-out"} data-aos={"fade-in"} className={"wp-block-group wp-container-content-b99e70a5 has-global-padding is-layout-constrained wp-container-core-group-is-layout-b818fde2 wp-block-group-is-layout-constrained wpbbe-b9db6909 wpbbe-flex-item-prevent-shrinking"} >
        {" "}
        <h3 className={"wp-block-heading"} >New offices & expanded services</h3>
        {" "}
        <div className={"wp-block-group is-layout-flow wp-block-group-is-layout-flow"} >
        {" "}
        <p className={"wp-block-paragraph"} >As our client base grew, we opened new offices to better serve businesses across multiple regions.</p>
        {" "}
        <p className={"wp-block-paragraph"} >
        ...
        {" "}
        <figure data-aos-easing={"ease-out"} data-aos={"slide-up"} className={"wp-block-image size-large is-style-default wp-container-content-9cfa9a5a wpbbe-0db3c306"} >
        <img referrerPolicy={"no-referrer"} loading={"lazy"} decoding={"async"} width={"1024"} height={"683"} src={"https://the7.io/fse-business/wp-content/uploads/sites/133/2026/02/b782-1024x683.webp"} alt={""} className={"wp-image-19711"} style={{ aspectRatio: "16/9", objectFit: "cover" } as CSSProperties} srcSet={"https://the7.io/fse-business/wp-content/uploads/sites/133/2026/02/b782-1024x683.webp 1024w, https://the7.io/fse-business/wp-content/uploads/sites/133/2026/02/b782-300x200.webp 300w, https://the7.io/fse-business/wp-content/uploads/sites/133/2026/02/b782-768x512.webp 768w, https://the7.io/fse-business/wp-content/uploads/sites/133/2026/02/b782-1536x1024.webp 1536w, https://the7.io/fse-business/wp-content/uploads/sites/133/2026/02/b782.webp 1800w"} sizes={"(max-width: 1024px) 100vw, 1024px"} />
        </figure>
        {" "}
        </div>
        {" "}
        ...
        {" "}
        <div className={"wp-block-group is-horizontal is-content-justification-space-between is-nowrap is-layout-flex wp-container-core-group-is-layout-c2c1c3f2 wp-block-group-is-layout-flex wpbbe-98fbddef"} >
        {" "}
        <div className={"wp-block-group wp-container-content-b04ba3db is-vertical is-content-justification-stretch is-layout-flex wp-container-core-group-is-layout-5b8ab76f wp-block-group-is-layout-flex wpbbe-flex-item-prevent-shrinking"} style={{ borderTopLeftRadius: "0px", borderTopRightRadius: "0px", borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px", borderRightColor: "var(--wp--preset--color--bbe-primary-200)", borderRightWidth: "1px", marginTop: "0", marginBottom: "0", paddingTop: "0", paddingRight: "0", paddingBottom: "0", paddingLeft: "0" } as CSSProperties} >
        {" "}
        <div className={"wp-block-group is-nowrap is-layout-flex wp-container-core-group-is-layout-b72bb12e wp-block-group-is-layout-flex"} >
        {" "}
        <p data-aos-easing={"ease-out"} data-aos={"slide-up"} className={"has-text-align-left has-bbe-primary-600-color has-text-color has-link-color wp-elements-37 wpbbe-e1b9125f wpbbe-text-style-from-element-h1 wp-block-heading wp-block-paragraph"} style={{ marginTop: "0", marginRight: "0", marginLeft: "0", paddingTop: "0", lineHeight: "1" } as CSSProperties} >2026</p>
        {" "}
        <hr className={"wp-block-separator has-text-color has-bbe-primary-200-color has-alpha-channel-opacity has-bbe-primary-200-background-color has-background is-style-wide wp-container-content-9cfa9a5a"} />
        {" "}
        </div>
        ...
        {" "}
        <div className={"wp-block-group is-content-justification-space-between is-nowrap is-layout-flex wp-container-core-group-is-layout-6564da59 wp-block-group-is-layout-flex wpbbe-5a20f10d"} style={{ marginTop: "0", marginBottom: "0", paddingTop: "0" } as CSSProperties} >
        {" "}
        <div data-aos-easing={"ease-out"} data-aos={"fade-in"} className={"wp-block-group wp-container-content-b99e70a5 has-global-padding is-layout-constrained wp-container-core-group-is-layout-b818fde2 wp-block-group-is-layout-constrained wpbbe-b374b5d5 wpbbe-flex-item-prevent-shrinking"} >
        {" "}
        <h3 className={"wp-block-heading"} >Expansion & growth</h3>
        {" "}
        <div className={"wp-block-group is-layout-flow wp-block-group-is-layout-flow"} >
        {" "}
        <p className={"wp-block-paragraph"} >We continue to grow, partnering with more businesses and strengthening our team of experts.</p>
        {" "}
        <p className={"wp-block-paragraph"} >
        ...
        {" "}
        <figure data-aos-easing={"ease-out"} data-aos={"slide-up"} className={"wp-block-image size-large is-style-default wp-container-content-9cfa9a5a wpbbe-6a8c604f"} >
        <img referrerPolicy={"no-referrer"} loading={"lazy"} decoding={"async"} width={"1024"} height={"683"} src={"https://the7.io/fse-business/wp-content/uploads/sites/133/2026/02/b761-1024x683.webp"} alt={""} className={"wp-image-19686"} style={{ aspectRatio: "16/9", objectFit: "cover" } as CSSProperties} srcSet={"https://the7.io/fse-business/wp-content/uploads/sites/133/2026/02/b761-1024x683.webp 1024w, https://the7.io/fse-business/wp-content/uploads/sites/133/2026/02/b761-300x200.webp 300w, https://the7.io/fse-business/wp-content/uploads/sites/133/2026/02/b761-768x512.webp 768w, https://the7.io/fse-business/wp-content/uploads/sites/133/2026/02/b761-1536x1024.webp 1536w, https://the7.io/fse-business/wp-content/uploads/sites/133/2026/02/b761.webp 1800w"} sizes={"(max-width: 1024px) 100vw, 1024px"} />
        </figure>
        {" "}
        </div>
        {" "}
        ...
        {" "}
        <div className={"wp-block-cover alignwide has-bbe-neutral-000-color has-text-color has-link-color wp-elements-38"} style={{ paddingTop: "0", paddingBottom: "0", minHeight: "500px", aspectRatio: "unset" } as CSSProperties} >
        <img referrerPolicy={"no-referrer"} loading={"lazy"} decoding={"async"} width={"1800"} height={"1200"} className={"wp-block-cover__image-background wp-image-19726 size-full"} alt={""} src={"https://the7.io/fse-business/wp-content/uploads/sites/133/2026/02/b099.webp"} style={{ objectPosition: "53% 48%" } as CSSProperties} data-object-fit={"cover"} data-object-position={"53% 48%"} srcSet={"https://the7.io/fse-business/wp-content/uploads/sites/133/2026/02/b099.webp 1800w, https://the7.io/fse-business/wp-content/uploads/sites/133/2026/02/b099-300x200.webp 300w, https://the7.io/fse-business/wp-content/uploads/sites/133/2026/02/b099-1024x683.webp 1024w, https://the7.io/fse-business/wp-content/uploads/sites/133/2026/02/b099-768x512.webp 768w, https://the7.io/fse-business/wp-content/uploads/sites/133/2026/02/b099-1536x1024.webp 1536w"} sizes={"(max-width: 1800px) 100vw, 1800px"} />
        <span aria-hidden={"true"} className={"wp-block-cover__background has-black-background-color has-background-dim-60 has-background-dim"} />
        ...
        {" "}
        <div className={"wp-block-group alignwide has-global-padding is-content-justification-center is-layout-constrained wp-container-core-group-is-layout-c586cbad wp-block-group-is-layout-constrained wpbbe-d34cd01c aos-root"} style={{ paddingTop: "var(--wp--preset--spacing--bbe-120)", paddingRight: "var(--wp--preset--spacing--bbe-120)", paddingBottom: "var(--wp--preset--spacing--bbe-120)", paddingLeft: "var(--wp--preset--spacing--bbe-120)" } as CSSProperties} >
        {" "}
        <h2 data-aos-easing={"ease-out"} data-aos={"slide-up"} className={"wp-block-heading has-text-align-center alignwide has-bbe-primary-300-color has-text-color has-link-color wp-elements-39 wpbbe-9bba21ca wpbbe-text-style-from-element-h4"} >
        <span style={{ backgroundImage: "var(--wp--preset--gradient--bbe-gradient-2)", animationName: "text-bg-animate-h", animationDuration: "5s" } as CSSProperties} className={"text-with-gradient"} >Practical advice. Meaningful results.</span>
        </h2>
        {" "}
        <h2 data-aos-easing={"ease-out"} data-aos={"slide-up"} className={"wp-block-heading has-text-align-center alignwide has-bbe-neutral-000-color has-text-color has-link-color has-bbe-display-3-font-size wp-elements-40 wpbbe-382f9ed7 wpbbe-text-style-from-element-h1"} >Strategic financial solutions for long-term success</h2>
        {" "}
        ...
        <a className={"wp-block-button__link has-text-align-center wp-element-button"} href={"https://the7.io/fse-business/contact/"} >Request a consultation</a>
        </div>
        {" "}
        <div style={{ "--wp-block-button--hover-background": "#ffffff1a" } as CSSProperties} className={"wp-block-button is-style-bbe-secondary-500 is-style-outline is-style-outline--8 has-hover-background"} >
        <a className={"wp-block-button__link has-bbe-neutral-000-color has-text-color has-background has-link-color has-border-color has-bbe-neutral-000-border-color has-text-align-center wp-element-button"} href={"https://the7.io/fse-business/services/"} style={{ backgroundColor: "#00000000" } as CSSProperties} >Explore our services</a>
        </div>
        {" "}
        </div>
        {" "}
        ...
        {" "}
        <p className={"has-bbe-neutral-900-color has-text-color has-link-color wp-elements-41 wpbbe-text-style-from-element-h5 wp-block-heading wp-block-paragraph"} >
        <mark style={{ backgroundColor: "rgba(0, 0, 0, 0)" } as CSSProperties} className={"has-inline-color has-bbe-primary-600-color"} >Call:</mark>
        {" +1-001-234-5678"}
        </p>
        {" "}
        ...
        <div className={"wp-block-group is-layout-flow wp-container-core-group-is-layout-2d0a040d wp-block-group-is-layout-flow"} >
        {" "}
        <p className={"has-bbe-neutral-900-color has-text-color has-link-color wp-elements-42 wpbbe-text-style-from-element-h6 wp-block-heading wp-block-paragraph"} >Info</p>
        {" "}
        ...
        <div className={"wp-block-group is-layout-flow wp-container-core-group-is-layout-2d0a040d wp-block-group-is-layout-flow"} >
        {" "}
        <p className={"has-bbe-neutral-900-color has-text-color has-link-color wp-elements-43 wpbbe-text-style-from-element-h6 wp-block-heading wp-block-paragraph"} >Services</p>
        {" "}
        ...
        <label className={"wp-block-search__label screen-reader-text"} htmlFor={"wp-block-search__input-9"} >Search</label>
        <div className={"wp-block-search__inside-wrapper"} style={{ width: "100%" } as CSSProperties} >
        <input className={"wp-block-search__input has-bbe-small-font-size"} id={"wp-block-search__input-9"} placeholder={"Search..."} defaultValue={""} type={"search"} name={"s"} required={true} style={{ borderWidth: "0px", borderStyle: "none" } as CSSProperties} />
