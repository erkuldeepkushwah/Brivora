  ...
  return (
    <>
      ...
      <div className={"wp-site-blocks"} >
        ...
        <img referrerPolicy={"no-referrer"} decoding={"async"} width={"800"} height={"400"} src={"https://the7.io/fse-business/wp-content/uploads/sites/133/2026/05/logo-color-04.svg"} alt={""} className={"wp-image-23696"} style={{ borderTopLeftRadius: "0px", borderTopRightRadius: "0px", borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px" } as CSSProperties} />
        </figure>
        {" "}
        ...
        <img referrerPolicy={"no-referrer"} decoding={"async"} width={"800"} height={"400"} src={"https://the7.io/fse-business/wp-content/uploads/sites/133/2026/05/logo-color-08.svg"} alt={""} className={"wp-image-23695"} style={{ borderTopLeftRadius: "0px", borderTopRightRadius: "0px", borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px" } as CSSProperties} />
        </figure>
        {" "}
        ...
        <input className={"wp-block-search__input has-bbe-small-font-size"} id={"wp-block-search__input-18"} placeholder={"Search..."} defaultValue={""} type={"search"} name={"s"} required={true} style={{ borderWidth: "0px", borderStyle: "none" } as CSSProperties} />
      ...
      <dialog className={"demo-panel"} id={"demopanel"} >
        ...
        <span className={"image-wrap"} >
        {" "}
        <img className={"load-on-click"} alt={"Digital agency"} loading={"lazy"} decoding={"async"} src={"https://the7.io/wp-content/uploads/2026/07/fse-cr-agency.webp"} srcSet={"https://the7.io/wp-content/uploads/2026/07/fse-cr-agency.webp 720w, https://the7.io/wp-content/uploads/2026/07/fse-cr-agency-670x1005.webp 670w, https://the7.io/wp-content/uploads/2026/07/fse-cr-agency-335x503.webp 335w"} referrerPolicy={"no-referrer"} sizes={"(min-width: 910px) 335px, (min-width: 620px) 395px, calc(100vw - 80px)"} width={"720"} height={"1080"} />
        {" "}
        </span>
        {" "}
