...
<title>Login &#8211; Block Editor Business</title>
...
<div class="wp-block-group alignfull has-global-padding is-layout-constrained" style="padding-top:var(--wp--preset--spacing--bbe-140);padding-bottom:var(--wp--preset--spacing--bbe-160)">
  <div class="wp-block-group alignwide is-layout-flex" style="justify-content:center;max-width:540px;margin:0 auto;background:#ffffff;border:1px solid var(--wp--preset--color--bbe-neutral-300);border-radius:12px;padding:40px 36px;box-shadow:0 10px 30px rgba(0,0,0,0.06);">
    <div style="width:100%;">
      <div style="text-align:center;margin-bottom:28px;">
        <h2 style="font-size:28px;font-weight:700;color:var(--wp--preset--color--bbe-neutral-900);margin-bottom:8px;">Welcome back</h2>
        <p style="color:var(--wp--preset--color--bbe-neutral-600);font-size:15px;margin:0;">Sign in to your account to continue</p>
      </div>

      <div id="login-alert" style="display:none;padding:12px 16px;border-radius:8px;background:#eef8f1;color:#1e7e34;font-size:14px;margin-bottom:20px;border:1px solid #c3e6cb;"></div>

      <form id="login-form" onsubmit="event.preventDefault(); document.getElementById('login-alert').style.display='block'; document.getElementById('login-alert').innerText='Login successful! Welcome back.'; setTimeout(function(){ window.location.href='/'; }, 1500);">
        <div style="margin-bottom:20px;">
          <label style="display:block;font-weight:600;font-size:14px;color:var(--wp--preset--color--bbe-neutral-900);margin-bottom:8px;" for="login-email">Email Address</label>
          <input id="login-email" type="email" required placeholder="name@company.com" style="width:100%;padding:12px 14px;font-size:15px;border:1px solid var(--wp--preset--color--bbe-neutral-300);border-radius:8px;outline:none;box-sizing:border-box;transition:border-color 0.2s;" onfocus="this.style.borderColor='var(--wp--preset--color--bbe-primary-600)'" onblur="this.style.borderColor='var(--wp--preset--color--bbe-neutral-300)'" />
        </div>

        <div style="margin-bottom:20px;">
          <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px;">
            <label style="font-weight:600;font-size:14px;color:var(--wp--preset--color--bbe-neutral-900);" for="login-password">Password</label>
            <a href="#" style="font-size:13px;color:var(--wp--preset--color--bbe-primary-600);text-decoration:none;" onclick="alert('Password reset link has been sent to your email.'); return false;">Forgot password?</a>
          </div>
          <input id="login-password" type="password" required placeholder="••••••••" style="width:100%;padding:12px 14px;font-size:15px;border:1px solid var(--wp--preset--color--bbe-neutral-300);border-radius:8px;outline:none;box-sizing:border-box;transition:border-color 0.2s;" onfocus="this.style.borderColor='var(--wp--preset--color--bbe-primary-600)'" onblur="this.style.borderColor='var(--wp--preset--color--bbe-neutral-300)'" />
        </div>

        <div style="display:flex;align-items:center;margin-bottom:24px;">
          <input type="checkbox" id="remember" style="width:16px;height:16px;margin-right:8px;accent-color:var(--wp--preset--color--bbe-primary-600);" />
          <label for="remember" style="font-size:14px;color:var(--wp--preset--color--bbe-neutral-700);cursor:pointer;">Remember me on this device</label>
        </div>

        <button type="submit" style="width:100%;padding:14px;background:var(--wp--preset--color--bbe-primary-600);color:#ffffff;border:none;border-radius:8px;font-size:16px;font-weight:600;cursor:pointer;transition:background 0.2s;" onmouseover="this.style.background='var(--wp--preset--color--bbe-primary-700)'" onmouseout="this.style.background='var(--wp--preset--color--bbe-primary-600)'">
          Sign In
        </button>
      </form>

      <div style="text-align:center;margin-top:24px;font-size:14px;color:var(--wp--preset--color--bbe-neutral-600);">
        Don't have an account? <a href="/contact" style="color:var(--wp--preset--color--bbe-primary-600);font-weight:600;text-decoration:none;">Contact us to get access</a>
      </div>
    </div>
  </div>
</div>
